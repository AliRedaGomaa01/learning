 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ic;function jf(){if(ic)return br;ic=1;var l=na(),u=Symbol.for("react.element"),s=Symbol.for("react.fragment"),m=Object.prototype.hasOwnProperty,d=l.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,g={key:!0,ref:!0,__self:!0,__source:!0};function S(E,k,x){var T,I={},N=null,D=null;x!==void 0&&(N=""+x),k.key!==void 0&&(N=""+k.key),k.ref!==void 0&&(D=k.ref);for(T in k)m.call(k,T)&&!g.hasOwnProperty(T)&&(I[T]=k[T]);if(E&&E.defaultProps)for(T in k=E.defaultProps,k)I[T]===void 0&&(I[T]=k[T]);return{$$typeof:u,type:E,key:N,ref:D,props:I,_owner:d.current}}return br.Fragment=s,br.jsx=S,br.jsxs=S,br}var lc;function Tf(){return lc||(lc=1,Ql.exports=jf()),Ql.exports}var C=Tf(),_=na(),Qo={},Gl={exports:{}},qe={},Kl={exports:{}},Yl={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ac;function Of(){return ac||(ac=1,function(l){function u(F,Y){var B=F.length;F.push(Y);e:for(;0<B;){var h=B-1>>>1,P=F[h];if(0<d(P,Y))F[h]=Y,F[B]=P,B=h;else break e}}function s(F){return F.length===0?null:F[0]}function m(F){if(F.length===0)return null;var Y=F[0],B=F.pop();if(B!==Y){F[0]=B;e:for(var h=0,P=F.length,J=P>>>1;h<J;){var ee=2*(h+1)-1,re=F[ee],oe=ee+1,ue=F[oe];if(0>d(re,B))oe<P&&0>d(ue,re)?(F[h]=ue,F[oe]=B,h=oe):(F[h]=re,F[ee]=B,h=ee);else if(oe<P&&0>d(ue,B))F[h]=ue,F[oe]=B,h=oe;else break e}}return Y}function d(F,Y){var B=F.sortIndex-Y.sortIndex;return B!==0?B:F.id-Y.id}if(typeof performance=="object"&&typeof performance.now=="function"){var g=performance;l.unstable_now=function(){return g.now()}}else{var S=Date,E=S.now();l.unstable_now=function(){return S.now()-E}}var k=[],x=[],T=1,I=null,N=3,D=!1,O=!1,A=!1,z=typeof setTimeout=="function"?setTimeout:null,M=typeof clearTimeout=="function"?clearTimeout:null,K=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function W(F){for(var Y=s(x);Y!==null;){if(Y.callback===null)m(x);else if(Y.startTime<=F)m(x),Y.sortIndex=Y.expirationTime,u(k,Y);else break;Y=s(x)}}function te(F){if(A=!1,W(F),!O)if(s(k)!==null)O=!0,Ue(se);else{var Y=s(x);Y!==null&&xe(te,Y.startTime-F)}}function se(F,Y){O=!1,A&&(A=!1,M(_e),_e=-1),D=!0;var B=N;try{for(W(Y),I=s(k);I!==null&&(!(I.expirationTime>Y)||F&&!mt());){var h=I.callback;if(typeof h=="function"){I.callback=null,N=I.priorityLevel;var P=h(I.expirationTime<=Y);Y=l.unstable_now(),typeof P=="function"?I.callback=P:I===s(k)&&m(k),W(Y)}else m(k);I=s(k)}if(I!==null)var J=!0;else{var ee=s(x);ee!==null&&xe(te,ee.startTime-Y),J=!1}return J}finally{I=null,N=B,D=!1}}var we=!1,he=null,_e=-1,ke=5,Ne=-1;function mt(){return!(l.unstable_now()-Ne<ke)}function ht(){if(he!==null){var F=l.unstable_now();Ne=F;var Y=!0;try{Y=he(!0,F)}finally{Y?Ge():(we=!1,he=null)}}else we=!1}var Ge;if(typeof K=="function")Ge=function(){K(ht)};else if(typeof MessageChannel<"u"){var lt=new MessageChannel,gt=lt.port2;lt.port1.onmessage=ht,Ge=function(){gt.postMessage(null)}}else Ge=function(){z(ht,0)};function Ue(F){he=F,we||(we=!0,Ge())}function xe(F,Y){_e=z(function(){F(l.unstable_now())},Y)}l.unstable_IdlePriority=5,l.unstable_ImmediatePriority=1,l.unstable_LowPriority=4,l.unstable_NormalPriority=3,l.unstable_Profiling=null,l.unstable_UserBlockingPriority=2,l.unstable_cancelCallback=function(F){F.callback=null},l.unstable_continueExecution=function(){O||D||(O=!0,Ue(se))},l.unstable_forceFrameRate=function(F){0>F||125<F?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ke=0<F?Math.floor(1e3/F):5},l.unstable_getCurrentPriorityLevel=function(){return N},l.unstable_getFirstCallbackNode=function(){return s(k)},l.unstable_next=function(F){switch(N){case 1:case 2:case 3:var Y=3;break;default:Y=N}var B=N;N=Y;try{return F()}finally{N=B}},l.unstable_pauseExecution=function(){},l.unstable_requestPaint=function(){},l.unstable_runWithPriority=function(F,Y){switch(F){case 1:case 2:case 3:case 4:case 5:break;default:F=3}var B=N;N=F;try{return Y()}finally{N=B}},l.unstable_scheduleCallback=function(F,Y,B){var h=l.unstable_now();switch(typeof B=="object"&&B!==null?(B=B.delay,B=typeof B=="number"&&0<B?h+B:h):B=h,F){case 1:var P=-1;break;case 2:P=250;break;case 5:P=1073741823;break;case 4:P=1e4;break;default:P=5e3}return P=B+P,F={id:T++,callback:Y,priorityLevel:F,startTime:B,expirationTime:P,sortIndex:-1},B>h?(F.sortIndex=B,u(x,F),s(k)===null&&F===s(x)&&(A?(M(_e),_e=-1):A=!0,xe(te,B-h))):(F.sortIndex=P,u(k,F),O||D||(O=!0,Ue(se))),F},l.unstable_shouldYield=mt,l.unstable_wrapCallback=function(F){var Y=N;return function(){var B=N;N=Y;try{return F.apply(this,arguments)}finally{N=B}}}}(Yl)),Yl}var sc;function zf(){return sc||(sc=1,Kl.exports=Of()),Kl.exports}/**
 * @license React
...
# define types
  ...
  * generic ( general not specific ) 
    ...
    - Ex
      ...
      `})}function Yf(){const l=["Web Basics","Github","Theoretical","Design","Css","Tailwind","OOP","Javascript","Typescript"],[u,s]=_.useState("Web Basics");return C.jsxs(C.Fragment,{children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Web Basics"&&C.jsx($f,{}),u==="Github"&&C.jsx(Af,{}),u==="Theoretical"&&C.jsx(Uf,{}),u==="Design"&&C.jsx(Bf,{}),u==="Css"&&C.jsx(Vf,{}),u==="Bootstrap"&&C.jsx(Hf,{}),u==="Tailwind"&&C.jsx(Wf,{}),u==="Sass"&&C.jsx(Qf,{}),u==="OOP"&&C.jsx(qf,{}),u==="Javascript"&&C.jsx(Gf,{}),u==="Typescript"&&C.jsx(Kf,{})]})}function Xf(){return C.jsx("pre",{children:`
# Authentication
...
# folders & structure :
  ...
  * constants to manage colors
      `})}function lp(){const l=["Common","Common Web","React","Next","Vue","Angular","Common Mobile","Flutter","React Native"],[u,s]=_.useState("Common");return C.jsxs(C.Fragment,{children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Common"&&C.jsx(Xf,{}),u==="Common Mobile"&&C.jsx(Jf,{}),u==="Common Web"&&C.jsx(Zf,{}),u==="React"&&C.jsx(ep,{}),u==="Next"&&C.jsx(tp,{}),u==="Vue"&&C.jsx(np,{}),u==="Angular"&&C.jsx(rp,{}),u==="Flutter"&&C.jsx(op,{}),u==="React Native"&&C.jsx(ip,{})]})}function ap(){return C.jsx("pre",{children:`    
# basics info
...
* marketing tools : 
  - email : mailchimp
`});function Ep(){const l=["Common","CMS","SEO"],[u,s]=_.useState("Common");return C.jsxs(C.Fragment,{children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Common"&&C.jsx(kp,{}),u==="CMS"&&C.jsx(xp,{}),u==="SEO"&&C.jsx(Sp,{})]})}function Cp(){const l=["Basics","Frontend","Backend","Database","Deployment","Marketing"],[u,s]=_.useState("Basics");return C.jsx(C.Fragment,{children:C.jsx("div",{className:"min-h-screen min-w-screen box-border p-2 md:p-5 flex flex-col",children:C.jsxs("div",{className:"border-8 border-black h-full w-full relative grow p-2 md:p-5 flex flex-col gap-5",children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Basics"&&C.jsx(Yf,{}),u==="Frontend"&&C.jsx(lp,{}),u==="Backend"&&C.jsx(dp,{}),u==="Database"&&C.jsx(gp,{}),u==="Deployment"&&C.jsx(wp,{}),u==="Marketing"&&C.jsx(Ep,{})]})})})}var Nr={},fc;function _p(){if(fc)return Nr;fc=1,Object.defineProperty(Nr,"__esModule",{value:!0}),Nr.parse=S,Nr.serialize=x;const l=/^[\u0021-\u003A\u003C\u003E-\u007E]+$/,u=/^[\u0021-\u003A\u003C-\u007E]*$/,s=/^([.]?[a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)([.][a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)*$/i,m=/^[\u0020-\u003A\u003D-\u007E]*$/,d=Object.prototype.toString,g=(()=>{const N=function(){};return N.prototype=Object.create(null),N})();function S(N,D){const O=new g,A=N.length;if(A<2)return O;const z=(D==null?void 0:D.decode)||T;let M=0;do{const K=N.indexOf("=",M);if(K===-1)break;const W=N.indexOf(";",M),te=W===-1?A:W;if(K>te){M=N.lastIndexOf(";",K-1)+1;continue}const se=E(N,M,K),we=k(N,K,se),he=N.slice(se,we);if(O[he]===void 0){let _e=E(N,K+1,te),ke=k(N,te,_e);const Ne=z(N.slice(_e,ke));O[he]=Ne}M=te+1}while(M<A);return O}function E(N,D,O){do{const A=N.charCodeAt(D);if(A!==32&&A!==9)return D}while(++D<O);return O}function k(N,D,O){for(;D>O;){const A=N.charCodeAt(--D);if(A!==32&&A!==9)return D+1}return O}function x(N,D,O){const A=(O==null?void 0:O.encode)||encodeURIComponent;if(!l.test(N))throw new TypeError(`argument name is invalid: ${N}`);const z=A(D);if(!u.test(z))throw new TypeError(`argument val is invalid: ${D}`);let M=N+"="+z;if(!O)return M;if(O.maxAge!==void 0){if(!Number.isInteger(O.maxAge))throw new TypeError(`option maxAge is invalid: ${O.maxAge}`);M+="; Max-Age="+O.maxAge}if(O.domain){if(!s.test(O.domain))throw new TypeError(`option domain is invalid: ${O.domain}`);M+="; Domain="+O.domain}if(O.path){if(!m.test(O.path))throw new TypeError(`option path is invalid: ${O.path}`);M+="; Path="+O.path}if(O.expires){if(!I(O.expires)||!Number.isFinite(O.expires.valueOf()))throw new TypeError(`option expires is invalid: ${O.expires}`);M+="; Expires="+O.expires.toUTCString()}if(O.httpOnly&&(M+="; HttpOnly"),O.secure&&(M+="; Secure"),O.partitioned&&(M+="; Partitioned"),O.priority)switch(typeof O.priority=="string"?O.priority.toLowerCase():void 0){case"low":M+="; Priority=Low";break;case"medium":M+="; Priority=Medium";break;case"high":M+="; Priority=High";break;default:throw new TypeError(`option priority is invalid: ${O.priority}`)}if(O.sameSite)switch(typeof O.sameSite=="string"?O.sameSite.toLowerCase():O.sameSite){case!0:case"strict":M+="; SameSite=Strict";break;case"lax":M+="; SameSite=Lax";break;case"none":M+="; SameSite=None";break;default:throw new TypeError(`option sameSite is invalid: ${O.sameSite}`)}return M}function T(N){if(N.indexOf("%")===-1)return N;try{return decodeURIComponent(N)}catch{return N}}function I(N){return d.call(N)==="[object Date]"}return Nr}_p();/**
 * react-router v7.1.5
 *
 ...
 *
 * @license MIT
 */var pc="popstate";function Rp(l={}){function u(m,d){let{pathname:g,search:S,hash:E}=m.location;return Zl("",{pathname:g,search:S,hash:E},d.state&&d.state.usr||null,d.state&&d.state.key||"default")}function s(m,d){return typeof d=="string"?d:jr(d)}return bp(u,s,null,l)}function ve(l,u){if(l===!1||l===null||typeof l>"u")throw new Error(u)}function St(l,u){if(!l){typeof console<"u"&&console.warn(u);try{throw new Error(u)}catch{}}}function Pp(){return Math.random().toString(36).substring(2,10)}function mc(l,u){return{usr:l.state,key:l.key,idx:u}}function Zl(l,u,s=null,m){return{pathname:typeof l=="string"?l:l.pathname,search:"",hash:"",...typeof u=="string"?Un(u):u,state:s,key:u&&u.key||m||Pp()}}function jr({pathname:l="/",search:u="",hash:s=""}){return u&&u!=="?"&&(l+=u.charAt(0)==="?"?u:"?"+u),s&&s!=="#"&&(l+=s.charAt(0)==="#"?s:"#"+s),l}function Un(l){let u={};if(l){let s=l.indexOf("#");s>=0&&(u.hash=l.substring(s),l=l.substring(0,s));let m=l.indexOf("?");m>=0&&(u.search=l.substring(m),l=l.substring(0,m)),l&&(u.pathname=l)}return u}function bp(l,u,s,m={}){let{window:d=document.defaultView,v5Compat:g=!1}=m,S=d.history,E="POP",k=null,x=T();x==null&&(x=0,S.replaceState({...S.state,idx:x},""));function T(){return(S.state||{idx:null}).idx}function I(){E="POP";let z=T(),M=z==null?null:z-x;x=z,k&&k({action:E,location:A.location,delta:M})}function N(z,M){E="PUSH";let K=Zl(A.location,z,M);x=T()+1;let W=mc(K,x),te=A.createHref(K);try{S.pushState(W,"",te)}catch(se){if(se instanceof DOMException&&se.name==="DataCloneError")throw se;d.location.assign(te)}g&&k&&k({action:E,location:A.location,delta:1})}function D(z,M){E="REPLACE";let K=Zl(A.location,z,M);x=T();let W=mc(K,x),te=A.createHref(K);S.replaceState(W,"",te),g&&k&&k({action:E,location:A.location,delta:0})}function O(z){let M=d.location.origin!=="null"?d.location.origin:d.location.href,K=typeof z=="string"?z:jr(z);return K=K.replace(/ $/,"%20"),ve(M,`No window.location.(origin|href) available to create URL for href: ${K}`),new URL(K,M)}let A={get action(){return E},get location(){return l(d,S)},listen(z){if(k)throw new Error("A history only accepts one active listener");return d.addEventListener(pc,I),k=z,()=>{d.removeEventListener(pc,I),k=null}},createHref(z){return u(d,z)},createURL:O,encodeLocation(z){let M=O(z);return{pathname:M.pathname,search:M.search,hash:M.hash}},push:N,replace:D,go(z){return S.go(z)}};return A}function vc(l,u,s="/"){return Np(l,u,s,!1)}function Np(l,u,s,m){let d=typeof u=="string"?Un(u):u,g=Zt(d.pathname||"/",s);if(g==null)return null;let S=wc(l);Lp(S);let E=null;for(let k=0;E==null&&k<S.length;++k){let x=Up(g);E=$p(S[k],x,m)}return E}function wc(l,u=[],s=[],m=""){let d=(g,S,E)=>{let k={relativePath:E===void 0?g.path||"":E,caseSensitive:g.caseSensitive===!0,childrenIndex:S,route:g};k.relativePath.startsWith("/")&&(ve(k.relativePath.startsWith(m),`Absolute route path "${k.relativePath}" nested under path "${m}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),k.relativePath=k.relativePath.slice(m.length));let x=Tt([m,k.relativePath]),T=s.concat(k);g.children&&g.children.length>0&&(ve(g.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${x}".`),wc(g.children,u,T,x)),!(g.path==null&&!g.index)&&u.push({path:x,score:Mp(x,g.index),routesMeta:T})};return l.forEach((g,S)=>{var E;if(g.path===""||!((E=g.path)!=null&&E.includes("?")))d(g,S);else for(let k of kc(g.path))d(g,S,k)}),u}function kc(l){let u=l.split("/");if(u.length===0)return[];let[s,...m]=u,d=s.endsWith("?"),g=s.replace(/\?$/,"");if(m.length===0)return d?[g,""]:[g];let S=kc(m.join("/")),E=[];return E.push(...S.map(k=>k===""?g:[g,k].join("/"))),d&&E.push(...S),E.map(k=>l.startsWith("/")&&k===""?"/":k)}function Lp(l){l.sort((u,s)=>u.score!==s.score?s.score-u.score:Fp(u.routesMeta.map(m=>m.childrenIndex),s.routesMeta.map(m=>m.childrenIndex)))}var jp=/^:[\w-]+$/,Tp=3,Op=2,zp=1,Ip=10,Dp=-2,hc=l=>l==="*";function Mp(l,u){let s=l.split("/"),m=s.length;return s.some(hc)&&(m+=Dp),u&&(m+=Op),s.filter(d=>!hc(d)).reduce((d,g)=>d+(jp.test(g)?Tp:g===""?zp:Ip),m)}function Fp(l,u){return l.length===u.length&&l.slice(0,-1).every((m,d)=>m===u[d])?l[l.length-1]-u[u.length-1]:0}function $p(l,u,s=!1){let{routesMeta:m}=l,d={},g="/",S=[];for(let E=0;E<m.length;++E){let k=m[E],x=E===m.length-1,T=g==="/"?u:u.slice(g.length)||"/",I=Yo({path:k.relativePath,caseSensitive:k.caseSensitive,end:x},T),N=k.route;if(!I&&x&&s&&!m[m.length-1].route.index&&(I=Yo({path:k.relativePath,caseSensitive:k.caseSensitive,end:!1},T)),!I)return null;Object.assign(d,I.params),S.push({params:d,pathname:Tt([g,I.pathname]),pathnameBase:Wp(Tt([g,I.pathnameBase])),route:N}),I.pathnameBase!=="/"&&(g=Tt([g,I.pathnameBase]))}return S}function Yo(l,u){typeof l=="string"&&(l={path:l,caseSensitive:!1,end:!0});let[s,m]=Ap(l.path,l.caseSensitive,l.end),d=u.match(s);if(!d)return null;let g=d[0],S=g.replace(/(.)\/+$/,"$1"),E=d.slice(1);return{params:m.reduce((x,{paramName:T,isOptional:I},N)=>{if(T==="*"){let O=E[N]||"";S=g.slice(0,g.length-O.length).replace(/(.)\/+$/,"$1")}const D=E[N];return I&&!D?x[T]=void 0:x[T]=(D||"").replace(/%2F/g,"/"),x},{}),pathname:g,pathnameBase:S,pattern:l}}function Ap(l,u=!1,s=!0){St(l==="*"||!l.endsWith("*")||l.endsWith("/*"),`Route path "${l}" will be treated as if it were "${l.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${l.replace(/\*$/,"/*")}".`);let m=[],d="^"+l.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(S,E,k)=>(m.push({paramName:E,isOptional:k!=null}),k?"/?([^\\/]+)?":"/([^\\/]+)"));return l.endsWith("*")?(m.push({paramName:"*"}),d+=l==="*"||l==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):s?d+="\\/*$":l!==""&&l!=="/"&&(d+="(?:(?=\\/|$))"),[new RegExp(d,u?void 0:"i"),m]}function Up(l){try{return l.split("/").map(u=>decodeURIComponent(u).replace(/\//g,"%2F")).join("/")}catch(u){return St(!1,`The URL path "${l}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${u}).`),l}}function Zt(l,u){if(u==="/")return l;if(!l.toLowerCase().startsWith(u.toLowerCase()))return null;let s=u.endsWith("/")?u.length-1:u.length,m=l.charAt(s);return m&&m!=="/"?null:l.slice(s)||"/"}function Bp(l,u="/"){let{pathname:s,search:m="",hash:d=""}=typeof l=="string"?Un(l):l;return{pathname:s?s.startsWith("/")?s:Vp(s,u):u,search:Qp(m),hash:qp(d)}}function Vp(l,u){let s=u.replace(/\/+$/,"").split("/");return l.split("/").forEach(d=>{d===".."?s.length>1&&s.pop():d!=="."&&s.push(d)}),s.length>1?s.join("/"):"/"}function Xl(l,u,s,m){return`Cannot include a '${l}' character in a manually specified \`to.${u}\` field [${JSON.stringify(m)}].  Please separate it out to the \`to.${s}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function Hp(l){return l.filter((u,s)=>s===0||u.route.path&&u.route.path.length>0)}function xc(l){let u=Hp(l);return u.map((s,m)=>m===u.length-1?s.pathname:s.pathnameBase)}function Sc(l,u,s,m=!1){let d;typeof l=="string"?d=Un(l):(d={...l},ve(!d.pathname||!d.pathname.includes("?"),Xl("?","pathname","search",d)),ve(!d.pathname||!d.pathname.includes("#"),Xl("#","pathname","hash",d)),ve(!d.search||!d.search.includes("#"),Xl("#","search","hash",d)));let g=l===""||d.pathname==="",S=g?"/":d.pathname,E;if(S==null)E=s;else{let I=u.length-1;if(!m&&S.startsWith("..")){let N=S.split("/");for(;N[0]==="..";)N.shift(),I-=1;d.pathname=N.join("/")}E=I>=0?u[I]:"/"}let k=Bp(d,E),x=S&&S!=="/"&&S.endsWith("/"),T=(g||S===".")&&s.endsWith("/");return!k.pathname.endsWith("/")&&(x||T)&&(k.pathname+="/"),k}var Tt=l=>l.join("/").replace(/\/\/+/g,"/"),Wp=l=>l.replace(/\/+$/,"").replace(/^\/*/,"/"),Qp=l=>!l||l==="?"?"":l.startsWith("?")?l:"?"+l,qp=l=>!l||l==="#"?"":l.startsWith("#")?l:"#"+l;function Gp(l){return l!=null&&typeof l.status=="number"&&typeof l.statusText=="string"&&typeof l.internal=="boolean"&&"data"in l}var Ec=["POST","PUT","PATCH","DELETE"];new Set(Ec);var Kp=["GET",...Ec];new Set(Kp);var Bn=_.createContext(null);Bn.displayName="DataRouter";var Xo=_.createContext(null);Xo.displayName="DataRouterState";var Cc=_.createContext({isTransitioning:!1});Cc.displayName="ViewTransition";var Yp=_.createContext(new Map);Yp.displayName="Fetchers";var Xp=_.createContext(null);Xp.displayName="Await";var Et=_.createContext(null);Et.displayName="Navigation";var Tr=_.createContext(null);Tr.displayName="Location";var Ot=_.createContext({outlet:null,matches:[],isDataRoute:!1});Ot.displayName="Route";var ra=_.createContext(null);ra.displayName="RouteError";function Jp(l,{relative:u}={}){ve(Or(),"useHref() may be used only in the context of a <Router> component.");let{basename:s,navigator:m}=_.useContext(Et),{hash:d,pathname:g,search:S}=zr(l,{relative:u}),E=g;return s!=="/"&&(E=g==="/"?s:Tt([s,g])),m.createHref({pathname:E,search:S,hash:d})}function Or(){return _.useContext(Tr)!=null}function hn(){return ve(Or(),"useLocation() may be used only in the context of a <Router> component."),_.useContext(Tr).location}var _c="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function Rc(l){_.useContext(Et).static||_.useLayoutEffect(l)}function Zp(){let{isDataRoute:l}=_.useContext(Ot);return l?fm():em()}function em(){ve(Or(),"useNavigate() may be used only in the context of a <Router> component.");let l=_.useContext(Bn),{basename:u,navigator:s}=_.useContext(Et),{matches:m}=_.useContext(Ot),{pathname:d}=hn(),g=JSON.stringify(xc(m)),S=_.useRef(!1);return Rc(()=>{S.current=!0}),_.useCallback((k,x={})=>{if(St(S.current,_c),!S.current)return;if(typeof k=="number"){s.go(k);return}let T=Sc(k,JSON.parse(g),d,x.relative==="path");l==null&&u!=="/"&&(T.pathname=T.pathname==="/"?u:Tt([u,T.pathname])),(x.replace?s.replace:s.push)(T,x.state,x)},[u,s,g,d,l])}_.createContext(null);function zr(l,{relative:u}={}){let{matches:s}=_.useContext(Ot),{pathname:m}=hn(),d=JSON.stringify(xc(s));return _.useMemo(()=>Sc(l,JSON.parse(d),m,u==="path"),[l,d,m,u])}function tm(l,u){return Pc(l,u)}function Pc(l,u,s,m){var K;ve(Or(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:d,static:g}=_.useContext(Et),{matches:S}=_.useContext(Ot),E=S[S.length-1],k=E?E.params:{},x=E?E.pathname:"/",T=E?E.pathnameBase:"/",I=E&&E.route;{let W=I&&I.path||"";bc(x,!I||W.endsWith("*")||W.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${x}" (under <Route path="${W}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${W}"> to <Route path="${W==="/"?"*":`${W}/*`}">.`)}let N=hn(),D;if(u){let W=typeof u=="string"?Un(u):u;ve(T==="/"||((K=W.pathname)==null?void 0:K.startsWith(T)),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${T}" but pathname "${W.pathname}" was given in the \`location\` prop.`),D=W}else D=N;let O=D.pathname||"/",A=O;if(T!=="/"){let W=T.replace(/^\//,"").split("/");A="/"+O.replace(/^\//,"").split("/").slice(W.length).join("/")}let z=!g&&s&&s.matches&&s.matches.length>0?s.matches:vc(l,{pathname:A});St(I||z!=null,`No routes matched location "${D.pathname}${D.search}${D.hash}" `),St(z==null||z[z.length-1].route.element!==void 0||z[z.length-1].route.Component!==void 0||z[z.length-1].route.lazy!==void 0,`Matched leaf route at location "${D.pathname}${D.search}${D.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let M=lm(z&&z.map(W=>Object.assign({},W,{params:Object.assign({},k,W.params),pathname:Tt([T,d.encodeLocation?d.encodeLocation(W.pathname).pathname:W.pathname]),pathnameBase:W.pathnameBase==="/"?T:Tt([T,d.encodeLocation?d.encodeLocation(W.pathnameBase).pathname:W.pathnameBase])})),S,s,m);return u&&M?_.createElement(Tr.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...D},navigationType:"POP"}},M):M}function nm(){let l=dm(),u=Gp(l)?`${l.status} ${l.statusText}`:l instanceof Error?l.message:JSON.stringify(l),s=l instanceof Error?l.stack:null,m="rgba(200,200,200, 0.5)",d={padding:"0.5rem",backgroundColor:m},g={padding:"2px 4px",backgroundColor:m},S=null;return console.error("Error handled by React Router default ErrorBoundary:",l),S=_.createElement(_.Fragment,null,_.createElement("p",null,"💿 Hey developer 👋"),_.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",_.createElement("code",{style:g},"ErrorBoundary")," or"," ",_.createElement("code",{style:g},"errorElement")," prop on your route.")),_.createElement(_.Fragment,null,_.createElement("h2",null,"Unexpected Application Error!"),_.createElement("h3",{style:{fontStyle:"italic"}},u),s?_.createElement("pre",{style:d},s):null,S)}var rm=_.createElement(nm,null),om=class extends _.Component{constructor(l){super(l),this.state={location:l.location,revalidation:l.revalidation,error:l.error}}static getDerivedStateFromError(l){return{error:l}}static getDerivedStateFromProps(l,u){return u.location!==l.location||u.revalidation!=="idle"&&l.revalidation==="idle"?{error:l.error,location:l.location,revalidation:l.revalidation}:{error:l.error!==void 0?l.error:u.error,location:u.location,revalidation:l.revalidation||u.revalidation}}componentDidCatch(l,u){console.error("React Router caught the following error during render",l,u)}render(){return this.state.error!==void 0?_.createElement(Ot.Provider,{value:this.props.routeContext},_.createElement(ra.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function im({routeContext:l,match:u,children:s}){let m=_.useContext(Bn);return m&&m.static&&m.staticContext&&(u.route.errorElement||u.route.ErrorBoundary)&&(m.staticContext._deepestRenderedBoundaryId=u.route.id),_.createElement(Ot.Provider,{value:l},s)}function lm(l,u=[],s=null,m=null){if(l==null){if(!s)return null;if(s.errors)l=s.matches;else if(u.length===0&&!s.initialized&&s.matches.length>0)l=s.matches;else return null}let d=l,g=s==null?void 0:s.errors;if(g!=null){let k=d.findIndex(x=>x.route.id&&(g==null?void 0:g[x.route.id])!==void 0);ve(k>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(g).join(",")}`),d=d.slice(0,Math.min(d.length,k+1))}let S=!1,E=-1;if(s)for(let k=0;k<d.length;k++){let x=d[k];if((x.route.HydrateFallback||x.route.hydrateFallbackElement)&&(E=k),x.route.id){let{loaderData:T,errors:I}=s,N=x.route.loader&&!T.hasOwnProperty(x.route.id)&&(!I||I[x.route.id]===void 0);if(x.route.lazy||N){S=!0,E>=0?d=d.slice(0,E+1):d=[d[0]];break}}}return d.reduceRight((k,x,T)=>{let I,N=!1,D=null,O=null;s&&(I=g&&x.route.id?g[x.route.id]:void 0,D=x.route.errorElement||rm,S&&(E<0&&T===0?(bc("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),N=!0,O=null):E===T&&(N=!0,O=x.route.hydrateFallbackElement||null)));let A=u.concat(d.slice(0,T+1)),z=()=>{let M;return I?M=D:N?M=O:x.route.Component?M=_.createElement(x.route.Component,null):x.route.element?M=x.route.element:M=k,_.createElement(im,{match:x,routeContext:{outlet:k,matches:A,isDataRoute:s!=null},children:M})};return s&&(x.route.ErrorBoundary||x.route.errorElement||T===0)?_.createElement(om,{location:s.location,revalidation:s.revalidation,component:D,error:I,children:z(),routeContext:{outlet:null,matches:A,isDataRoute:!0}}):z()},null)}function oa(l){return`${l} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function am(l){let u=_.useContext(Bn);return ve(u,oa(l)),u}function sm(l){let u=_.useContext(Xo);return ve(u,oa(l)),u}function um(l){let u=_.useContext(Ot);return ve(u,oa(l)),u}function ia(l){let u=um(l),s=u.matches[u.matches.length-1];return ve(s.route.id,`${l} can only be used on routes that contain a unique "id"`),s.route.id}function cm(){return ia("useRouteId")}function dm(){var m;let l=_.useContext(ra),u=sm("useRouteError"),s=ia("useRouteError");return l!==void 0?l:(m=u.errors)==null?void 0:m[s]}function fm(){let{router:l}=am("useNavigate"),u=ia("useNavigate"),s=_.useRef(!1);return Rc(()=>{s.current=!0}),_.useCallback(async(d,g={})=>{St(s.current,_c),s.current&&(typeof d=="number"?l.navigate(d):await l.navigate(d,{fromRouteId:u,...g}))},[l,u])}var gc={};function bc(l,u,s){!u&&!gc[l]&&(gc[l]=!0,St(!1,s))}_.memo(pm);function pm({routes:l,future:u,state:s}){return Pc(l,void 0,s,u)}function ea(l){ve(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function mm({basename:l="/",children:u=null,location:s,navigationType:m="POP",navigator:d,static:g=!1}){ve(!Or(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let S=l.replace(/^\/*/,"/"),E=_.useMemo(()=>({basename:S,navigator:d,static:g,future:{}}),[S,d,g]);typeof s=="string"&&(s=Un(s));let{pathname:k="/",search:x="",hash:T="",state:I=null,key:N="default"}=s,D=_.useMemo(()=>{let O=Zt(k,S);return O==null?null:{location:{pathname:O,search:x,hash:T,state:I,key:N},navigationType:m}},[S,k,x,T,I,N,m]);return St(D!=null,`<Router basename="${S}"> is not able to match the URL "${k}${x}${T}" because it does not start with the basename, so the <Router> won't render anything.`),D==null?null:_.createElement(Et.Provider,{value:E},_.createElement(Tr.Provider,{children:u,value:D}))}function hm({children:l,location:u}){return tm(ta(l),u)}function ta(l,u=[]){let s=[];return _.Children.forEach(l,(m,d)=>{if(!_.isValidElement(m))return;let g=[...u,d];if(m.type===_.Fragment){s.push.apply(s,ta(m.props.children,g));return}ve(m.type===ea,`[${typeof m.type=="string"?m.type:m.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),ve(!m.props.index||!m.props.children,"An index route cannot have child routes.");let S={id:m.props.id||g.join("-"),caseSensitive:m.props.caseSensitive,element:m.props.element,Component:m.props.Component,index:m.props.index,path:m.props.path,loader:m.props.loader,action:m.props.action,hydrateFallbackElement:m.props.hydrateFallbackElement,HydrateFallback:m.props.HydrateFallback,errorElement:m.props.errorElement,ErrorBoundary:m.props.ErrorBoundary,hasErrorBoundary:m.props.hasErrorBoundary===!0||m.props.ErrorBoundary!=null||m.props.errorElement!=null,shouldRevalidate:m.props.shouldRevalidate,handle:m.props.handle,lazy:m.props.lazy};m.props.children&&(S.children=ta(m.props.children,g)),s.push(S)}),s}var Go="get",Ko="application/x-www-form-urlencoded";function Jo(l){return l!=null&&typeof l.tagName=="string"}function gm(l){return Jo(l)&&l.tagName.toLowerCase()==="button"}function ym(l){return Jo(l)&&l.tagName.toLowerCase()==="form"}function vm(l){return Jo(l)&&l.tagName.toLowerCase()==="input"}function wm(l){return!!(l.metaKey||l.altKey||l.ctrlKey||l.shiftKey)}function km(l,u){return l.button===0&&(!u||u==="_self")&&!wm(l)}var qo=null;function xm(){if(qo===null)try{new FormData(document.createElement("form"),0),qo=!1}catch{qo=!0}return qo}var Sm=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function Jl(l){return l!=null&&!Sm.has(l)?(St(!1,`"${l}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Ko}"`),null):l}function Em(l,u){let s,m,d,g,S;if(ym(l)){let E=l.getAttribute("action");m=E?Zt(E,u):null,s=l.getAttribute("method")||Go,d=Jl(l.getAttribute("enctype"))||Ko,g=new FormData(l)}else if(gm(l)||vm(l)&&(l.type==="submit"||l.type==="image")){let E=l.form;if(E==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let k=l.getAttribute("formaction")||E.getAttribute("action");if(m=k?Zt(k,u):null,s=l.getAttribute("formmethod")||E.getAttribute("method")||Go,d=Jl(l.getAttribute("formenctype"))||Jl(E.getAttribute("enctype"))||Ko,g=new FormData(E,l),!xm()){let{name:x,type:T,value:I}=l;if(T==="image"){let N=x?`${x}.`:"";g.append(`${N}x`,"0"),g.append(`${N}y`,"0")}else x&&g.append(x,I)}}else{if(Jo(l))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');s=Go,m=null,d=Ko,S=l}return g&&d==="text/plain"&&(S=g,g=void 0),{action:m,method:s.toLowerCase(),encType:d,formData:g,body:S}}function la(l,u){if(l===!1||l===null||typeof l>"u")throw new Error(u)}async function Cm(l,u){if(l.id in u)return u[l.id];try{let s=await import(l.module);return u[l.id]=s,s}catch(s){return console.error(`Error loading route module \`${l.module}\`, reloading page...`),console.error(s),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function _m(l){return l==null?!1:l.href==null?l.rel==="preload"&&typeof l.imageSrcSet=="string"&&typeof l.imageSizes=="string":typeof l.rel=="string"&&typeof l.href=="string"}async function Rm(l,u,s){let m=await Promise.all(l.map(async d=>{let g=u.routes[d.route.id];if(g){let S=await Cm(g,s);return S.links?S.links():[]}return[]}));return Lm(m.flat(1).filter(_m).filter(d=>d.rel==="stylesheet"||d.rel==="preload").map(d=>d.rel==="stylesheet"?{...d,rel:"prefetch",as:"style"}:{...d,rel:"prefetch"}))}function yc(l,u,s,m,d,g){let S=(k,x)=>s[x]?k.route.id!==s[x].route.id:!0,E=(k,x)=>{var T;return s[x].pathname!==k.pathname||((T=s[x].route.path)==null?void 0:T.endsWith("*"))&&s[x].params["*"]!==k.params["*"]};return g==="assets"?u.filter((k,x)=>S(k,x)||E(k,x)):g==="data"?u.filter((k,x)=>{var I;let T=m.routes[k.route.id];if(!T||!T.hasLoader)return!1;if(S(k,x)||E(k,x))return!0;if(k.route.shouldRevalidate){let N=k.route.shouldRevalidate({currentUrl:new URL(d.pathname+d.search+d.hash,window.origin),currentParams:((I=s[0])==null?void 0:I.params)||{},nextUrl:new URL(l,window.origin),nextParams:k.params,defaultShouldRevalidate:!0});if(typeof N=="boolean")return N}return!0}):[]}function Pm(l,u){return bm(l.map(s=>{let m=u.routes[s.route.id];if(!m)return[];let d=[m.module];return m.imports&&(d=d.concat(m.imports)),d}).flat(1))}function bm(l){return[...new Set(l)]}function Nm(l){let u={},s=Object.keys(l).sort();for(let m of s)u[m]=l[m];return u}function Lm(l,u){let s=new Set;return new Set(u),l.reduce((m,d)=>{let g=JSON.stringify(Nm(d));return s.has(g)||(s.add(g),m.push({key:g,link:d})),m},[])}function jm(l){let u=typeof l=="string"?new URL(l,typeof window>"u"?"server://singlefetch/":window.location.origin):l;return u.pathname==="/"?u.pathname="_root.data":u.pathname=`${u.pathname.replace(/\/$/,"")}.data`,u}function Tm(){let l=_.useContext(Bn);return la(l,"You must render this element inside a <DataRouterContext.Provider> element"),l}function Om(){let l=_.useContext(Xo);return la(l,"You must render this element inside a <DataRouterStateContext.Provider> element"),l}var aa=_.createContext(void 0);aa.displayName="FrameworkContext";function Nc(){let l=_.useContext(aa);return la(l,"You must render this element inside a <HydratedRouter> element"),l}function zm(l,u){let s=_.useContext(aa),[m,d]=_.useState(!1),[g,S]=_.useState(!1),{onFocus:E,onBlur:k,onMouseEnter:x,onMouseLeave:T,onTouchStart:I}=u,N=_.useRef(null);_.useEffect(()=>{if(l==="render"&&S(!0),l==="viewport"){let A=M=>{M.forEach(K=>{S(K.isIntersecting)})},z=new IntersectionObserver(A,{threshold:.5});return N.current&&z.observe(N.current),()=>{z.disconnect()}}},[l]),_.useEffect(()=>{if(m){let A=setTimeout(()=>{S(!0)},100);return()=>{clearTimeout(A)}}},[m]);let D=()=>{d(!0)},O=()=>{d(!1),S(!1)};return s?l!=="intent"?[g,N,{}]:[g,N,{onFocus:Lr(E,D),onBlur:Lr(k,O),onMouseEnter:Lr(x,D),onMouseLeave:Lr(T,O),onTouchStart:Lr(I,D)}]:[!1,N,{}]}function Lr(l,u){return s=>{l&&l(s),s.defaultPrevented||u(s)}}function Im({page:l,...u}){let{router:s}=Tm(),m=_.useMemo(()=>vc(s.routes,l,s.basename),[s.routes,l,s.basename]);return m?_.createElement(Mm,{page:l,matches:m,...u}):null}function Dm(l){let{manifest:u,routeModules:s}=Nc(),[m,d]=_.useState([]);return _.useEffect(()=>{let g=!1;return Rm(l,u,s).then(S=>{g||d(S)}),()=>{g=!0}},[l,u,s]),m}function Mm({page:l,matches:u,...s}){let m=hn(),{manifest:d,routeModules:g}=Nc(),{loaderData:S,matches:E}=Om(),k=_.useMemo(()=>yc(l,u,E,d,m,"data"),[l,u,E,d,m]),x=_.useMemo(()=>yc(l,u,E,d,m,"assets"),[l,u,E,d,m]),T=_.useMemo(()=>{if(l===m.pathname+m.search+m.hash)return[];let D=new Set,O=!1;if(u.forEach(z=>{var K;let M=d.routes[z.route.id];!M||!M.hasLoader||(!k.some(W=>W.route.id===z.route.id)&&z.route.id in S&&((K=g[z.route.id])!=null&&K.shouldRevalidate)||M.hasClientLoader?O=!0:D.add(z.route.id))}),D.size===0)return[];let A=jm(l);return O&&D.size>0&&A.searchParams.set("_routes",u.filter(z=>D.has(z.route.id)).map(z=>z.route.id).join(",")),[A.pathname+A.search]},[S,m,d,k,u,l,g]),I=_.useMemo(()=>Pm(x,d),[x,d]),N=Dm(x);return _.createElement(_.Fragment,null,T.map(D=>_.createElement("link",{key:D,rel:"prefetch",as:"fetch",href:D,...s})),I.map(D=>_.createElement("link",{key:D,rel:"modulepreload",href:D,...s})),N.map(({key:D,link:O})=>_.createElement("link",{key:D,...O})))}function Fm(...l){return u=>{l.forEach(s=>{typeof s=="function"?s(u):s!=null&&(s.current=u)})}}var Lc=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{Lc&&(window.__reactRouterVersion="7.1.5")}catch{}function $m({basename:l,children:u,window:s}){let m=_.useRef();m.current==null&&(m.current=Rp({window:s,v5Compat:!0}));let d=m.current,[g,S]=_.useState({action:d.action,location:d.location}),E=_.useCallback(k=>{_.startTransition(()=>S(k))},[S]);return _.useLayoutEffect(()=>d.listen(E),[d,E]),_.createElement(mm,{basename:l,children:u,location:g.location,navigationType:g.action,navigator:d})}var jc=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,sa=_.forwardRef(function({onClick:u,discover:s="render",prefetch:m="none",relative:d,reloadDocument:g,replace:S,state:E,target:k,to:x,preventScrollReset:T,viewTransition:I,...N},D){let{basename:O}=_.useContext(Et),A=typeof x=="string"&&jc.test(x),z,M=!1;if(typeof x=="string"&&A&&(z=x,Lc))try{let ke=new URL(window.location.href),Ne=x.startsWith("//")?new URL(ke.protocol+x):new URL(x),mt=Zt(Ne.pathname,O);Ne.origin===ke.origin&&mt!=null?x=mt+Ne.search+Ne.hash:M=!0}catch{St(!1,`<Link to="${x}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let K=Jp(x,{relative:d}),[W,te,se]=zm(m,N),we=Vm(x,{replace:S,state:E,target:k,preventScrollReset:T,relative:d,viewTransition:I});function he(ke){u&&u(ke),ke.defaultPrevented||we(ke)}let _e=_.createElement("a",{...N,...se,href:z||K,onClick:M||g?u:he,ref:Fm(D,te),target:k,"data-discover":!A&&s==="render"?"true":void 0});return W&&!A?_.createElement(_.Fragment,null,_e,_.createElement(Im,{page:K})):_e});sa.displayName="Link";var Am=_.forwardRef(function({"aria-current":u="page",caseSensitive:s=!1,className:m="",end:d=!1,style:g,to:S,viewTransition:E,children:k,...x},T){let I=zr(S,{relative:x.relative}),N=hn(),D=_.useContext(Xo),{navigator:O,basename:A}=_.useContext(Et),z=D!=null&&Gm(I)&&E===!0,M=O.encodeLocation?O.encodeLocation(I).pathname:I.pathname,K=N.pathname,W=D&&D.navigation&&D.navigation.location?D.navigation.location.pathname:null;s||(K=K.toLowerCase(),W=W?W.toLowerCase():null,M=M.toLowerCase()),W&&A&&(W=Zt(W,A)||W);const te=M!=="/"&&M.endsWith("/")?M.length-1:M.length;let se=K===M||!d&&K.startsWith(M)&&K.charAt(te)==="/",we=W!=null&&(W===M||!d&&W.startsWith(M)&&W.charAt(M.length)==="/"),he={isActive:se,isPending:we,isTransitioning:z},_e=se?u:void 0,ke;typeof m=="function"?ke=m(he):ke=[m,se?"active":null,we?"pending":null,z?"transitioning":null].filter(Boolean).join(" ");let Ne=typeof g=="function"?g(he):g;return _.createElement(sa,{...x,"aria-current":_e,className:ke,ref:T,style:Ne,to:S,viewTransition:E},typeof k=="function"?k(he):k)});Am.displayName="NavLink";var Um=_.forwardRef(({discover:l="render",fetcherKey:u,navigate:s,reloadDocument:m,replace:d,state:g,method:S=Go,action:E,onSubmit:k,relative:x,preventScrollReset:T,viewTransition:I,...N},D)=>{let O=Qm(),A=qm(E,{relative:x}),z=S.toLowerCase()==="get"?"get":"post",M=typeof E=="string"&&jc.test(E),K=W=>{if(k&&k(W),W.defaultPrevented)return;W.preventDefault();let te=W.nativeEvent.submitter,se=(te==null?void 0:te.getAttribute("formmethod"))||S;O(te||W.currentTarget,{fetcherKey:u,method:se,navigate:s,replace:d,state:g,relative:x,preventScrollReset:T,viewTransition:I})};return _.createElement("form",{ref:D,method:z,action:A,onSubmit:m?k:K,...N,"data-discover":!M&&l==="render"?"true":void 0})});Um.displayName="Form";function Bm(l){return`${l} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Tc(l){let u=_.useContext(Bn);return ve(u,Bm(l)),u}function Vm(l,{target:u,replace:s,state:m,preventScrollReset:d,relative:g,viewTransition:S}={}){let E=Zp(),k=hn(),x=zr(l,{relative:g});return _.useCallback(T=>{if(km(T,u)){T.preventDefault();let I=s!==void 0?s:jr(k)===jr(x);E(l,{replace:I,state:m,preventScrollReset:d,relative:g,viewTransition:S})}},[k,E,x,s,m,u,l,d,g,S])}var Hm=0,Wm=()=>`__${String(++Hm)}__`;function Qm(){let{router:l}=Tc("useSubmit"),{basename:u}=_.useContext(Et),s=cm();return _.useCallback(async(m,d={})=>{let{action:g,method:S,encType:E,formData:k,body:x}=Em(m,u);if(d.navigate===!1){let T=d.fetcherKey||Wm();await l.fetch(T,s,d.action||g,{preventScrollReset:d.preventScrollReset,formData:k,body:x,formMethod:d.method||S,formEncType:d.encType||E,flushSync:d.flushSync})}else await l.navigate(d.action||g,{preventScrollReset:d.preventScrollReset,formData:k,body:x,formMethod:d.method||S,formEncType:d.encType||E,replace:d.replace,state:d.state,fromRouteId:s,flushSync:d.flushSync,viewTransition:d.viewTransition})},[l,u,s])}function qm(l,{relative:u}={}){let{basename:s}=_.useContext(Et),m=_.useContext(Ot);ve(m,"useFormAction must be used inside a RouteContext");let[d]=m.matches.slice(-1),g={...zr(l||".",{relative:u})},S=hn();if(l==null){g.search=S.search;let E=new URLSearchParams(g.search),k=E.getAll("index");if(k.some(T=>T==="")){E.delete("index"),k.filter(I=>I).forEach(I=>E.append("index",I));let T=E.toString();g.search=T?`?${T}`:""}}return(!l||l===".")&&d.route.index&&(g.search=g.search?g.search.replace(/^\?/,"?index&"):"?index"),s!=="/"&&(g.pathname=g.pathname==="/"?s:Tt([s,g.pathname])),jr(g)}function Gm(l,u={}){let s=_.useContext(Cc);ve(s!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:m}=Tc("useViewTransitionState"),d=zr(l,{relative:u.relative});if(!s.isTransitioning)return!1;let g=Zt(s.currentLocation.pathname,m)||s.currentLocation.pathname,S=Zt(s.nextLocation.pathname,m)||s.nextLocation.pathname;return Yo(d.pathname,S)!=null||Yo(d.pathname,g)!=null}new TextEncoder;function Km(){return C.jsxs("div",{className:"flex min-h-screen flex-col items-center justify-center bg-gray-100 p-6 text-center",children:[C.jsx("h1",{className:"text-6xl font-bold text-gray-800",children:"404"}),C.jsx("p",{className:"mt-2 text-lg text-gray-600",children:"Page Not Found"}),C.jsx(sa,{to:"/",className:"mt-4 text-blue-500 hover:underline",children:"Go Back Home"})]})}function Ym(){return C.jsx(C.Fragment,{children:C.jsx($m,{children:C.jsxs(hm,{children:[C.jsx(ea,{path:"/",element:C.jsx(Cp,{})}),C.jsx(ea,{path:"*",element:C.jsx(Km,{})})]})})})}Ff.createRoot(document.getElementById("root")).render(C.jsx(_.StrictMode,{children:C.jsx(Ym,{})}));
