 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ac;function Of(){return ac||(ac=1,function(l){function u(D,X){var B=D.length;D.push(X);e:for(;0<B;){var h=B-1>>>1,b=D[h];if(0<d(b,X))D[h]=X,D[B]=b,B=h;else break e}}function s(D){return D.length===0?null:D[0]}function m(D){if(D.length===0)return null;var X=D[0],B=D.pop();if(B!==X){D[0]=B;e:for(var h=0,b=D.length,J=b>>>1;h<J;){var ee=2*(h+1)-1,re=D[ee],oe=ee+1,ue=D[oe];if(0>d(re,B))oe<b&&0>d(ue,re)?(D[h]=ue,D[oe]=B,h=oe):(D[h]=re,D[ee]=B,h=ee);else if(oe<b&&0>d(ue,B))D[h]=ue,D[oe]=B,h=oe;else break e}}return X}function d(D,X){var B=D.sortIndex-X.sortIndex;return B!==0?B:D.id-X.id}if(typeof performance=="object"&&typeof performance.now=="function"){var g=performance;l.unstable_now=function(){return g.now()}}else{var S=Date,E=S.now();l.unstable_now=function(){return S.now()-E}}var k=[],x=[],j=1,$=null,N=3,z=!1,O=!1,A=!1,I=typeof setTimeout=="function"?setTimeout:null,M=typeof clearTimeout=="function"?clearTimeout:null,K=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function W(D){for(var X=s(x);X!==null;){if(X.callback===null)m(x);else if(X.startTime<=D)m(x),X.sortIndex=X.expirationTime,u(k,X);else break;X=s(x)}}function te(D){if(A=!1,W(D),!O)if(s(k)!==null)O=!0,Ue(se);else{var X=s(x);X!==null&&xe(te,X.startTime-D)}}function se(D,X){O=!1,A&&(A=!1,M(_e),_e=-1),z=!0;var B=N;try{for(W(X),$=s(k);$!==null&&(!($.expirationTime>X)||D&&!mt());){var h=$.callback;if(typeof h=="function"){$.callback=null,N=$.priorityLevel;var b=h($.expirationTime<=X);X=l.unstable_now(),typeof b=="function"?$.callback=b:$===s(k)&&m(k),W(X)}else m(k);$=s(k)}if($!==null)var J=!0;else{var ee=s(x);ee!==null&&xe(te,ee.startTime-X),J=!1}return J}finally{$=null,N=B,z=!1}}var we=!1,he=null,_e=-1,ke=5,Ne=-1;function mt(){return!(l.unstable_now()-Ne<ke)}function ht(){if(he!==null){var D=l.unstable_now();Ne=D;var X=!0;try{X=he(!0,D)}finally{X?Ge():(we=!1,he=null)}}else we=!1}var Ge;if(typeof K=="function")Ge=function(){K(ht)};else if(typeof MessageChannel<"u"){var lt=new MessageChannel,gt=lt.port2;lt.port1.onmessage=ht,Ge=function(){gt.postMessage(null)}}else Ge=function(){I(ht,0)};function Ue(D){he=D,we||(we=!0,Ge())}function xe(D,X){_e=I(function(){D(l.unstable_now())},X)}l.unstable_IdlePriority=5,l.unstable_ImmediatePriority=1,l.unstable_LowPriority=4,l.unstable_NormalPriority=3,l.unstable_Profiling=null,l.unstable_UserBlockingPriority=2,l.unstable_cancelCallback=function(D){D.callback=null},l.unstable_continueExecution=function(){O||z||(O=!0,Ue(se))},l.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ke=0<D?Math.floor(1e3/D):5},l.unstable_getCurrentPriorityLevel=function(){return N},l.unstable_getFirstCallbackNode=function(){return s(k)},l.unstable_next=function(D){switch(N){case 1:case 2:case 3:var X=3;break;default:X=N}var B=N;N=X;try{return D()}finally{N=B}},l.unstable_pauseExecution=function(){},l.unstable_requestPaint=function(){},l.unstable_runWithPriority=function(D,X){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var B=N;N=D;try{return X()}finally{N=B}},l.unstable_scheduleCallback=function(D,X,B){var h=l.unstable_now();switch(typeof B=="object"&&B!==null?(B=B.delay,B=typeof B=="number"&&0<B?h+B:h):B=h,D){case 1:var b=-1;break;case 2:b=250;break;case 5:b=1073741823;break;case 4:b=1e4;break;default:b=5e3}return b=B+b,D={id:j++,callback:X,priorityLevel:D,startTime:B,expirationTime:b,sortIndex:-1},B>h?(D.sortIndex=B,u(x,D),s(k)===null&&D===s(x)&&(A?(M(_e),_e=-1):A=!0,xe(te,B-h))):(D.sortIndex=b,u(k,D),O||z||(O=!0,Ue(se))),D},l.unstable_shouldYield=mt,l.unstable_wrapCallback=function(D){var X=N;return function(){var B=N;N=X;try{return D.apply(this,arguments)}finally{N=B}}}}(Xl)),Xl}var sc;function If(){return sc||(sc=1,Kl.exports=Of()),Kl.exports}/**
 * @license React
...
# define types
  ...
  * generic ( general not specific ) 
    ...
    - Ex
      ...
      `})}function Xf(){const l=["Web Basics","Github","Theoretical","Design","Css","Tailwind","OOP","Javascript","Typescript"],[u,s]=_.useState("Web Basics");return C.jsxs(C.Fragment,{children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Web Basics"&&C.jsx(Ff,{}),u==="Github"&&C.jsx(Af,{}),u==="Theoretical"&&C.jsx(Uf,{}),u==="Design"&&C.jsx(Bf,{}),u==="Css"&&C.jsx(Hf,{}),u==="Bootstrap"&&C.jsx(Vf,{}),u==="Tailwind"&&C.jsx(Wf,{}),u==="Sass"&&C.jsx(qf,{}),u==="OOP"&&C.jsx(Qf,{}),u==="Javascript"&&C.jsx(Gf,{}),u==="Typescript"&&C.jsx(Kf,{})]})}function Yf(){return C.jsx("pre",{children:`
# Authentication
...
*****************
  ...
  * blade template engine :
    ...
    * forms : 
      ...
      `})}function ap(){const l=["Common","Common Web","React","Next","Vue","Angular","Laravel","Common Mobile","Flutter","React Native"],[u,s]=_.useState("Common");return C.jsxs(C.Fragment,{children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Common"&&C.jsx(Yf,{}),u==="Common Mobile"&&C.jsx(Jf,{}),u==="Common Web"&&C.jsx(Zf,{}),u==="React"&&C.jsx(ep,{}),u==="Next"&&C.jsx(tp,{}),u==="Vue"&&C.jsx(np,{}),u==="Angular"&&C.jsx(rp,{}),u==="Laravel"&&C.jsx(lp,{}),u==="Flutter"&&C.jsx(op,{}),u==="React Native"&&C.jsx(ip,{})]})}function sp(){return C.jsx("pre",{children:`    
# basics info
