 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ic;function jf(){if(ic)return br;ic=1;var l=na(),u=Symbol.for("react.element"),s=Symbol.for("react.fragment"),m=Object.prototype.hasOwnProperty,d=l.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,g={key:!0,ref:!0,__self:!0,__source:!0};function S(E,k,x){var T,z={},N=null,D=null;x!==void 0&&(N=""+x),k.key!==void 0&&(N=""+k.key),k.ref!==void 0&&(D=k.ref);for(T in k)m.call(k,T)&&!g.hasOwnProperty(T)&&(z[T]=k[T]);if(E&&E.defaultProps)for(T in k=E.defaultProps,k)z[T]===void 0&&(z[T]=k[T]);return{$$typeof:u,type:E,key:N,ref:D,props:z,_owner:d.current}}return br.Fragment=s,br.jsx=S,br.jsxs=S,br}var lc;function Tf(){return lc||(lc=1,Ql.exports=jf()),Ql.exports}var C=Tf(),_=na(),Qo={},Gl={exports:{}},qe={},Kl={exports:{}},Xl={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ac;function Of(){return ac||(ac=1,function(l){function u(F,X){var B=F.length;F.push(X);e:for(;0<B;){var h=B-1>>>1,P=F[h];if(0<d(P,X))F[h]=X,F[B]=P,B=h;else break e}}function s(F){return F.length===0?null:F[0]}function m(F){if(F.length===0)return null;var X=F[0],B=F.pop();if(B!==X){F[0]=B;e:for(var h=0,P=F.length,J=P>>>1;h<J;){var ee=2*(h+1)-1,re=F[ee],oe=ee+1,ue=F[oe];if(0>d(re,B))oe<P&&0>d(ue,re)?(F[h]=ue,F[oe]=B,h=oe):(F[h]=re,F[ee]=B,h=ee);else if(oe<P&&0>d(ue,B))F[h]=ue,F[oe]=B,h=oe;else break e}}return X}function d(F,X){var B=F.sortIndex-X.sortIndex;return B!==0?B:F.id-X.id}if(typeof performance=="object"&&typeof performance.now=="function"){var g=performance;l.unstable_now=function(){return g.now()}}else{var S=Date,E=S.now();l.unstable_now=function(){return S.now()-E}}var k=[],x=[],T=1,z=null,N=3,D=!1,O=!1,A=!1,I=typeof setTimeout=="function"?setTimeout:null,M=typeof clearTimeout=="function"?clearTimeout:null,K=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function W(F){for(var X=s(x);X!==null;){if(X.callback===null)m(x);else if(X.startTime<=F)m(x),X.sortIndex=X.expirationTime,u(k,X);else break;X=s(x)}}function te(F){if(A=!1,W(F),!O)if(s(k)!==null)O=!0,Ue(se);else{var X=s(x);X!==null&&xe(te,X.startTime-F)}}function se(F,X){O=!1,A&&(A=!1,M(_e),_e=-1),D=!0;var B=N;try{for(W(X),z=s(k);z!==null&&(!(z.expirationTime>X)||F&&!mt());){var h=z.callback;if(typeof h=="function"){z.callback=null,N=z.priorityLevel;var P=h(z.expirationTime<=X);X=l.unstable_now(),typeof P=="function"?z.callback=P:z===s(k)&&m(k),W(X)}else m(k);z=s(k)}if(z!==null)var J=!0;else{var ee=s(x);ee!==null&&xe(te,ee.startTime-X),J=!1}return J}finally{z=null,N=B,D=!1}}var we=!1,he=null,_e=-1,ke=5,Ne=-1;function mt(){return!(l.unstable_now()-Ne<ke)}function ht(){if(he!==null){var F=l.unstable_now();Ne=F;var X=!0;try{X=he(!0,F)}finally{X?Ge():(we=!1,he=null)}}else we=!1}var Ge;if(typeof K=="function")Ge=function(){K(ht)};else if(typeof MessageChannel<"u"){var lt=new MessageChannel,gt=lt.port2;lt.port1.onmessage=ht,Ge=function(){gt.postMessage(null)}}else Ge=function(){I(ht,0)};function Ue(F){he=F,we||(we=!0,Ge())}function xe(F,X){_e=I(function(){F(l.unstable_now())},X)}l.unstable_IdlePriority=5,l.unstable_ImmediatePriority=1,l.unstable_LowPriority=4,l.unstable_NormalPriority=3,l.unstable_Profiling=null,l.unstable_UserBlockingPriority=2,l.unstable_cancelCallback=function(F){F.callback=null},l.unstable_continueExecution=function(){O||D||(O=!0,Ue(se))},l.unstable_forceFrameRate=function(F){0>F||125<F?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ke=0<F?Math.floor(1e3/F):5},l.unstable_getCurrentPriorityLevel=function(){return N},l.unstable_getFirstCallbackNode=function(){return s(k)},l.unstable_next=function(F){switch(N){case 1:case 2:case 3:var X=3;break;default:X=N}var B=N;N=X;try{return F()}finally{N=B}},l.unstable_pauseExecution=function(){},l.unstable_requestPaint=function(){},l.unstable_runWithPriority=function(F,X){switch(F){case 1:case 2:case 3:case 4:case 5:break;default:F=3}var B=N;N=F;try{return X()}finally{N=B}},l.unstable_scheduleCallback=function(F,X,B){var h=l.unstable_now();switch(typeof B=="object"&&B!==null?(B=B.delay,B=typeof B=="number"&&0<B?h+B:h):B=h,F){case 1:var P=-1;break;case 2:P=250;break;case 5:P=1073741823;break;case 4:P=1e4;break;default:P=5e3}return P=B+P,F={id:T++,callback:X,priorityLevel:F,startTime:B,expirationTime:P,sortIndex:-1},B>h?(F.sortIndex=B,u(x,F),s(k)===null&&F===s(x)&&(A?(M(_e),_e=-1):A=!0,xe(te,B-h))):(F.sortIndex=P,u(k,F),O||D||(O=!0,Ue(se))),F},l.unstable_shouldYield=mt,l.unstable_wrapCallback=function(F){var X=N;return function(){var B=N;N=X;try{return F.apply(this,arguments)}finally{N=B}}}}(Xl)),Xl}var sc;function If(){return sc||(sc=1,Kl.exports=Of()),Kl.exports}/**
 * @license React
...
`});function Ep(){const l=["Common","CMS","SEO"],[u,s]=_.useState("Common");return C.jsxs(C.Fragment,{children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Common"&&C.jsx(kp,{}),u==="CMS"&&C.jsx(xp,{}),u==="SEO"&&C.jsx(Sp,{})]})}function Cp(){const l=["Basics","Frontend","Backend","Database","Deployment","Marketing"],[u,s]=_.useState("Basics");return C.jsx(C.Fragment,{children:C.jsx("div",{className:"min-h-screen min-w-screen box-border p-2 md:p-5 flex flex-col",children:C.jsxs("div",{className:"border-8 border-black h-full w-full relative grow p-2 md:p-5 flex flex-col gap-5",children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Basics"&&C.jsx(Xf,{}),u==="Frontend"&&C.jsx(lp,{}),u==="Backend"&&C.jsx(dp,{}),u==="Database"&&C.jsx(gp,{}),u==="Deployment"&&C.jsx(wp,{}),u==="Marketing"&&C.jsx(Ep,{})]})})})}var Nr={},fc;function _p(){if(fc)return Nr;fc=1,Object.defineProperty(Nr,"__esModule",{value:!0}),Nr.parse=S,Nr.serialize=x;const l=/^[\u0021-\u003A\u003C\u003E-\u007E]+$/,u=/^[\u0021-\u003A\u003C-\u007E]*$/,s=/^([.]?[a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)([.][a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)*$/i,m=/^[\u0020-\u003A\u003D-\u007E]*$/,d=Object.prototype.toString,g=(()=>{const N=function(){};return N.prototype=Object.create(null),N})();function S(N,D){const O=new g,A=N.length;if(A<2)return O;const I=(D==null?void 0:D.decode)||T;let M=0;do{const K=N.indexOf("=",M);if(K===-1)break;const W=N.indexOf(";",M),te=W===-1?A:W;if(K>te){M=N.lastIndexOf(";",K-1)+1;continue}const se=E(N,M,K),we=k(N,K,se),he=N.slice(se,we);if(O[he]===void 0){let _e=E(N,K+1,te),ke=k(N,te,_e);const Ne=I(N.slice(_e,ke));O[he]=Ne}M=te+1}while(M<A);return O}function E(N,D,O){do{const A=N.charCodeAt(D);if(A!==32&&A!==9)return D}while(++D<O);return O}function k(N,D,O){for(;D>O;){const A=N.charCodeAt(--D);if(A!==32&&A!==9)return D+1}return O}function x(N,D,O){const A=(O==null?void 0:O.encode)||encodeURIComponent;if(!l.test(N))throw new TypeError(`argument name is invalid: ${N}`);const I=A(D);if(!u.test(I))throw new TypeError(`argument val is invalid: ${D}`);let M=N+"="+I;if(!O)return M;if(O.maxAge!==void 0){if(!Number.isInteger(O.maxAge))throw new TypeError(`option maxAge is invalid: ${O.maxAge}`);M+="; Max-Age="+O.maxAge}if(O.domain){if(!s.test(O.domain))throw new TypeError(`option domain is invalid: ${O.domain}`);M+="; Domain="+O.domain}if(O.path){if(!m.test(O.path))throw new TypeError(`option path is invalid: ${O.path}`);M+="; Path="+O.path}if(O.expires){if(!z(O.expires)||!Number.isFinite(O.expires.valueOf()))throw new TypeError(`option expires is invalid: ${O.expires}`);M+="; Expires="+O.expires.toUTCString()}if(O.httpOnly&&(M+="; HttpOnly"),O.secure&&(M+="; Secure"),O.partitioned&&(M+="; Partitioned"),O.priority)switch(typeof O.priority=="string"?O.priority.toLowerCase():void 0){case"low":M+="; Priority=Low";break;case"medium":M+="; Priority=Medium";break;case"high":M+="; Priority=High";break;default:throw new TypeError(`option priority is invalid: ${O.priority}`)}if(O.sameSite)switch(typeof O.sameSite=="string"?O.sameSite.toLowerCase():O.sameSite){case!0:case"strict":M+="; SameSite=Strict";break;case"lax":M+="; SameSite=Lax";break;case"none":M+="; SameSite=None";break;default:throw new TypeError(`option sameSite is invalid: ${O.sameSite}`)}return M}function T(N){if(N.indexOf("%")===-1)return N;try{return decodeURIComponent(N)}catch{return N}}function z(N){return d.call(N)==="[object Date]"}return Nr}_p();/**
 * react-router v7.1.5
 *
