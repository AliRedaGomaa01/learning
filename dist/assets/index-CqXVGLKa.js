 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ac;function Of(){return ac||(ac=1,function(l){function u(M,X){var B=M.length;M.push(X);e:for(;0<B;){var h=B-1>>>1,b=M[h];if(0<d(b,X))M[h]=X,M[B]=b,B=h;else break e}}function s(M){return M.length===0?null:M[0]}function m(M){if(M.length===0)return null;var X=M[0],B=M.pop();if(B!==X){M[0]=B;e:for(var h=0,b=M.length,J=b>>>1;h<J;){var ee=2*(h+1)-1,re=M[ee],oe=ee+1,ue=M[oe];if(0>d(re,B))oe<b&&0>d(ue,re)?(M[h]=ue,M[oe]=B,h=oe):(M[h]=re,M[ee]=B,h=ee);else if(oe<b&&0>d(ue,B))M[h]=ue,M[oe]=B,h=oe;else break e}}return X}function d(M,X){var B=M.sortIndex-X.sortIndex;return B!==0?B:M.id-X.id}if(typeof performance=="object"&&typeof performance.now=="function"){var g=performance;l.unstable_now=function(){return g.now()}}else{var S=Date,E=S.now();l.unstable_now=function(){return S.now()-E}}var k=[],x=[],j=1,$=null,N=3,z=!1,O=!1,A=!1,I=typeof setTimeout=="function"?setTimeout:null,D=typeof clearTimeout=="function"?clearTimeout:null,K=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function W(M){for(var X=s(x);X!==null;){if(X.callback===null)m(x);else if(X.startTime<=M)m(x),X.sortIndex=X.expirationTime,u(k,X);else break;X=s(x)}}function te(M){if(A=!1,W(M),!O)if(s(k)!==null)O=!0,Ue(se);else{var X=s(x);X!==null&&xe(te,X.startTime-M)}}function se(M,X){O=!1,A&&(A=!1,D(_e),_e=-1),z=!0;var B=N;try{for(W(X),$=s(k);$!==null&&(!($.expirationTime>X)||M&&!mt());){var h=$.callback;if(typeof h=="function"){$.callback=null,N=$.priorityLevel;var b=h($.expirationTime<=X);X=l.unstable_now(),typeof b=="function"?$.callback=b:$===s(k)&&m(k),W(X)}else m(k);$=s(k)}if($!==null)var J=!0;else{var ee=s(x);ee!==null&&xe(te,ee.startTime-X),J=!1}return J}finally{$=null,N=B,z=!1}}var we=!1,he=null,_e=-1,ke=5,Ne=-1;function mt(){return!(l.unstable_now()-Ne<ke)}function ht(){if(he!==null){var M=l.unstable_now();Ne=M;var X=!0;try{X=he(!0,M)}finally{X?Ge():(we=!1,he=null)}}else we=!1}var Ge;if(typeof K=="function")Ge=function(){K(ht)};else if(typeof MessageChannel<"u"){var lt=new MessageChannel,gt=lt.port2;lt.port1.onmessage=ht,Ge=function(){gt.postMessage(null)}}else Ge=function(){I(ht,0)};function Ue(M){he=M,we||(we=!0,Ge())}function xe(M,X){_e=I(function(){M(l.unstable_now())},X)}l.unstable_IdlePriority=5,l.unstable_ImmediatePriority=1,l.unstable_LowPriority=4,l.unstable_NormalPriority=3,l.unstable_Profiling=null,l.unstable_UserBlockingPriority=2,l.unstable_cancelCallback=function(M){M.callback=null},l.unstable_continueExecution=function(){O||z||(O=!0,Ue(se))},l.unstable_forceFrameRate=function(M){0>M||125<M?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ke=0<M?Math.floor(1e3/M):5},l.unstable_getCurrentPriorityLevel=function(){return N},l.unstable_getFirstCallbackNode=function(){return s(k)},l.unstable_next=function(M){switch(N){case 1:case 2:case 3:var X=3;break;default:X=N}var B=N;N=X;try{return M()}finally{N=B}},l.unstable_pauseExecution=function(){},l.unstable_requestPaint=function(){},l.unstable_runWithPriority=function(M,X){switch(M){case 1:case 2:case 3:case 4:case 5:break;default:M=3}var B=N;N=M;try{return X()}finally{N=B}},l.unstable_scheduleCallback=function(M,X,B){var h=l.unstable_now();switch(typeof B=="object"&&B!==null?(B=B.delay,B=typeof B=="number"&&0<B?h+B:h):B=h,M){case 1:var b=-1;break;case 2:b=250;break;case 5:b=1073741823;break;case 4:b=1e4;break;default:b=5e3}return b=B+b,M={id:j++,callback:X,priorityLevel:M,startTime:B,expirationTime:b,sortIndex:-1},B>h?(M.sortIndex=B,u(x,M),s(k)===null&&M===s(x)&&(A?(D(_e),_e=-1):A=!0,xe(te,B-h))):(M.sortIndex=b,u(k,M),O||z||(O=!0,Ue(se))),M},l.unstable_shouldYield=mt,l.unstable_wrapCallback=function(M){var X=N;return function(){var B=N;N=X;try{return M.apply(this,arguments)}finally{N=B}}}}(Xl)),Xl}var sc;function If(){return sc||(sc=1,Kl.exports=Of()),Kl.exports}/**
 * @license React
...
# examples
  *  .center {
      ...
      `}),Wf=()=>C.jsx("pre",{children:`
          
      `});function qf(){return C.jsx("pre",{children:`
# place-items
...
# Code notes
  ...
  * console.dir( myobject ) // print object props and methods 
    ...
    `})}function Xf(){return C.jsx("pre",{children:`
...
# define types
  ...
  * generic ( general not specific ) 
    ...
    - Ex
      ...
      `})}function Yf(){const l=["Web Basics","Github","Docker","Theoretical","Design","Css","Tailwind","OOP","Javascript","Typescript"],[u,s]=_.useState("Web Basics");return C.jsxs(C.Fragment,{children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Web Basics"&&C.jsx(Ff,{}),u==="Github"&&C.jsx(Af,{}),u==="Docker"&&C.jsx(Uf,{}),u==="Theoretical"&&C.jsx(Bf,{}),u==="Design"&&C.jsx(Hf,{}),u==="Css"&&C.jsx(Vf,{}),u==="Bootstrap"&&C.jsx(Wf,{}),u==="Tailwind"&&C.jsx(qf,{}),u==="Sass"&&C.jsx(Qf,{}),u==="OOP"&&C.jsx(Gf,{}),u==="Javascript"&&C.jsx(Kf,{}),u==="Typescript"&&C.jsx(Xf,{})]})}function Jf(){return C.jsx("pre",{children:`
# Authentication
...
# folders & structure :
  ...
  * constants to manage colors
      `})}function ap(){return C.jsx("pre",{children:`
...
*****************
  ...
  * blade template engine :
    ...
    * forms : 
      ...
      `})}function sp(){const l=["Common","Common Web","React","Next","Vue","Angular","Laravel","Common Mobile","Flutter","React Native"],[u,s]=_.useState("Common");return C.jsxs(C.Fragment,{children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Common"&&C.jsx(Jf,{}),u==="Common Mobile"&&C.jsx(Zf,{}),u==="Common Web"&&C.jsx(ep,{}),u==="React"&&C.jsx(tp,{}),u==="Next"&&C.jsx(np,{}),u==="Vue"&&C.jsx(rp,{}),u==="Angular"&&C.jsx(op,{}),u==="Laravel"&&C.jsx(ap,{}),u==="Flutter"&&C.jsx(ip,{}),u==="React Native"&&C.jsx(lp,{})]})}function up(){return C.jsx("pre",{children:`    
# basics info
...
# views 
  * put each view file in a folder with unique name 
      `})}function dp(){return C.jsx("div",{children:C.jsx("pre",{children:`
# some info
...
# graphQL ( package used with many languages not only js )
  ...
  * can be tested using postman or using a feature in it enable graphical GUI like docs for your api 
  ...
  # suggested hosting providers :
    ...
    * aws
    * vercel
        `})})}function fp(){return C.jsx("pre",{children:`
...
`})}function pp(){const l=["Common","Express","Laravel"],[u,s]=_.useState("Common");return C.jsxs(C.Fragment,{children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Common"&&C.jsx(up,{}),u==="Django"&&C.jsx(cp,{}),u==="Express"&&C.jsx(dp,{}),u==="Laravel"&&C.jsx(fp,{})]})}function mp(){return C.jsx("pre",{children:`
# Basics Info
...
# relations :  
  ...
  * morph-many
      ...
      `})}function hp(){return C.jsx("pre",{})}function gp(){return C.jsx("pre",{children:`
...
# performance :
  * use relations & reduce storing as json
      ...
      `})}function vp(){const l=["Common","Express","Laravel"],[u,s]=_.useState("Common");return C.jsxs(C.Fragment,{children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Common"&&C.jsx(mp,{}),u==="Django"&&C.jsx(hp,{}),u==="Express"&&C.jsx(gp,{}),u==="Laravel"&&C.jsx(yp,{})]})}function wp(){return C.jsx("pre",{children:`
# important info
  * test on a real device before start publishing
  * you must see the official doc of the used technology & of the store 
`})}function kp(){return C.jsx("pre",{children:`
...
<IfModule mod_rewrite.c>
  ...
  RewriteRule ^(.*) /index.html [NC,L]
      ...
      `})}function xp(){const l=["Web","Mobile"],[u,s]=_.useState("Web");return C.jsxs(C.Fragment,{children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Web"&&C.jsx(kp,{}),u==="Mobile"&&C.jsx(wp,{})]})}function Sp(){return C.jsx("pre",{children:`
...
* marketing tools : 
  - email : mailchimp
`});function _p(){const l=["Common","CMS","SEO"],[u,s]=_.useState("Common");return C.jsxs(C.Fragment,{children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Common"&&C.jsx(Sp,{}),u==="CMS"&&C.jsx(Ep,{}),u==="SEO"&&C.jsx(Cp,{})]})}function Rp(){const l=["Basics","Frontend","Backend","Database","Deployment","Marketing"],[u,s]=_.useState("Basics");return C.jsx(C.Fragment,{children:C.jsx("div",{className:"min-h-screen min-w-screen box-border p-2 md:p-5 flex flex-col",children:C.jsxs("div",{className:"border-8 border-black h-full w-full relative grow p-2 md:p-5 flex flex-col gap-5",children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Basics"&&C.jsx(Yf,{}),u==="Frontend"&&C.jsx(sp,{}),u==="Backend"&&C.jsx(pp,{}),u==="Database"&&C.jsx(vp,{}),u==="Deployment"&&C.jsx(xp,{}),u==="Marketing"&&C.jsx(_p,{})]})})})}var Nr={},fc;function bp(){if(fc)return Nr;fc=1,Object.defineProperty(Nr,"__esModule",{value:!0}),Nr.parse=S,Nr.serialize=x;const l=/^[\u0021-\u003A\u003C\u003E-\u007E]+$/,u=/^[\u0021-\u003A\u003C-\u007E]*$/,s=/^([.]?[a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)([.][a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)*$/i,m=/^[\u0020-\u003A\u003D-\u007E]*$/,d=Object.prototype.toString,g=(()=>{const N=function(){};return N.prototype=Object.create(null),N})();function S(N,z){const O=new g,A=N.length;if(A<2)return O;const I=(z==null?void 0:z.decode)||j;let D=0;do{const K=N.indexOf("=",D);if(K===-1)break;const W=N.indexOf(";",D),te=W===-1?A:W;if(K>te){D=N.lastIndexOf(";",K-1)+1;continue}const se=E(N,D,K),we=k(N,K,se),he=N.slice(se,we);if(O[he]===void 0){let _e=E(N,K+1,te),ke=k(N,te,_e);const Ne=I(N.slice(_e,ke));O[he]=Ne}D=te+1}while(D<A);return O}function E(N,z,O){do{const A=N.charCodeAt(z);if(A!==32&&A!==9)return z}while(++z<O);return O}function k(N,z,O){for(;z>O;){const A=N.charCodeAt(--z);if(A!==32&&A!==9)return z+1}return O}function x(N,z,O){const A=(O==null?void 0:O.encode)||encodeURIComponent;if(!l.test(N))throw new TypeError(`argument name is invalid: ${N}`);const I=A(z);if(!u.test(I))throw new TypeError(`argument val is invalid: ${z}`);let D=N+"="+I;if(!O)return D;if(O.maxAge!==void 0){if(!Number.isInteger(O.maxAge))throw new TypeError(`option maxAge is invalid: ${O.maxAge}`);D+="; Max-Age="+O.maxAge}if(O.domain){if(!s.test(O.domain))throw new TypeError(`option domain is invalid: ${O.domain}`);D+="; Domain="+O.domain}if(O.path){if(!m.test(O.path))throw new TypeError(`option path is invalid: ${O.path}`);D+="; Path="+O.path}if(O.expires){if(!$(O.expires)||!Number.isFinite(O.expires.valueOf()))throw new TypeError(`option expires is invalid: ${O.expires}`);D+="; Expires="+O.expires.toUTCString()}if(O.httpOnly&&(D+="; HttpOnly"),O.secure&&(D+="; Secure"),O.partitioned&&(D+="; Partitioned"),O.priority)switch(typeof O.priority=="string"?O.priority.toLowerCase():void 0){case"low":D+="; Priority=Low";break;case"medium":D+="; Priority=Medium";break;case"high":D+="; Priority=High";break;default:throw new TypeError(`option priority is invalid: ${O.priority}`)}if(O.sameSite)switch(typeof O.sameSite=="string"?O.sameSite.toLowerCase():O.sameSite){case!0:case"strict":D+="; SameSite=Strict";break;case"lax":D+="; SameSite=Lax";break;case"none":D+="; SameSite=None";break;default:throw new TypeError(`option sameSite is invalid: ${O.sameSite}`)}return D}function j(N){if(N.indexOf("%")===-1)return N;try{return decodeURIComponent(N)}catch{return N}}function $(N){return d.call(N)==="[object Date]"}return Nr}bp();/**
 * react-router v7.1.5
 *
 ...
 *
 * @license MIT
 */var pc="popstate";function Pp(l={}){function u(m,d){let{pathname:g,search:S,hash:E}=m.location;return Zl("",{pathname:g,search:S,hash:E},d.state&&d.state.usr||null,d.state&&d.state.key||"default")}function s(m,d){return typeof d=="string"?d:Tr(d)}return Lp(u,s,null,l)}function ve(l,u){if(l===!1||l===null||typeof l>"u")throw new Error(u)}function St(l,u){if(!l){typeof console<"u"&&console.warn(u);try{throw new Error(u)}catch{}}}function Np(){return Math.random().toString(36).substring(2,10)}function mc(l,u){return{usr:l.state,key:l.key,idx:u}}function Zl(l,u,s=null,m){return{pathname:typeof l=="string"?l:l.pathname,search:"",hash:"",...typeof u=="string"?Un(u):u,state:s,key:u&&u.key||m||Np()}}function Tr({pathname:l="/",search:u="",hash:s=""}){return u&&u!=="?"&&(l+=u.charAt(0)==="?"?u:"?"+u),s&&s!=="#"&&(l+=s.charAt(0)==="#"?s:"#"+s),l}function Un(l){let u={};if(l){let s=l.indexOf("#");s>=0&&(u.hash=l.substring(s),l=l.substring(0,s));let m=l.indexOf("?");m>=0&&(u.search=l.substring(m),l=l.substring(0,m)),l&&(u.pathname=l)}return u}function Lp(l,u,s,m={}){let{window:d=document.defaultView,v5Compat:g=!1}=m,S=d.history,E="POP",k=null,x=j();x==null&&(x=0,S.replaceState({...S.state,idx:x},""));function j(){return(S.state||{idx:null}).idx}function $(){E="POP";let I=j(),D=I==null?null:I-x;x=I,k&&k({action:E,location:A.location,delta:D})}function N(I,D){E="PUSH";let K=Zl(A.location,I,D);x=j()+1;let W=mc(K,x),te=A.createHref(K);try{S.pushState(W,"",te)}catch(se){if(se instanceof DOMException&&se.name==="DataCloneError")throw se;d.location.assign(te)}g&&k&&k({action:E,location:A.location,delta:1})}function z(I,D){E="REPLACE";let K=Zl(A.location,I,D);x=j();let W=mc(K,x),te=A.createHref(K);S.replaceState(W,"",te),g&&k&&k({action:E,location:A.location,delta:0})}function O(I){let D=d.location.origin!=="null"?d.location.origin:d.location.href,K=typeof I=="string"?I:Tr(I);return K=K.replace(/ $/,"%20"),ve(D,`No window.location.(origin|href) available to create URL for href: ${K}`),new URL(K,D)}let A={get action(){return E},get location(){return l(d,S)},listen(I){if(k)throw new Error("A history only accepts one active listener");return d.addEventListener(pc,$),k=I,()=>{d.removeEventListener(pc,$),k=null}},createHref(I){return u(d,I)},createURL:O,encodeLocation(I){let D=O(I);return{pathname:D.pathname,search:D.search,hash:D.hash}},push:N,replace:z,go(I){return S.go(I)}};return A}function vc(l,u,s="/"){return Tp(l,u,s,!1)}function Tp(l,u,s,m){let d=typeof u=="string"?Un(u):u,g=Zt(d.pathname||"/",s);if(g==null)return null;let S=wc(l);jp(S);let E=null;for(let k=0;E==null&&k<S.length;++k){let x=Hp(g);E=Up(S[k],x,m)}return E}function wc(l,u=[],s=[],m=""){let d=(g,S,E)=>{let k={relativePath:E===void 0?g.path||"":E,caseSensitive:g.caseSensitive===!0,childrenIndex:S,route:g};k.relativePath.startsWith("/")&&(ve(k.relativePath.startsWith(m),`Absolute route path "${k.relativePath}" nested under path "${m}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),k.relativePath=k.relativePath.slice(m.length));let x=jt([m,k.relativePath]),j=s.concat(k);g.children&&g.children.length>0&&(ve(g.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${x}".`),wc(g.children,u,j,x)),!(g.path==null&&!g.index)&&u.push({path:x,score:Fp(x,g.index),routesMeta:j})};return l.forEach((g,S)=>{var E;if(g.path===""||!((E=g.path)!=null&&E.includes("?")))d(g,S);else for(let k of kc(g.path))d(g,S,k)}),u}function kc(l){let u=l.split("/");if(u.length===0)return[];let[s,...m]=u,d=s.endsWith("?"),g=s.replace(/\?$/,"");if(m.length===0)return d?[g,""]:[g];let S=kc(m.join("/")),E=[];return E.push(...S.map(k=>k===""?g:[g,k].join("/"))),d&&E.push(...S),E.map(k=>l.startsWith("/")&&k===""?"/":k)}function jp(l){l.sort((u,s)=>u.score!==s.score?s.score-u.score:Ap(u.routesMeta.map(m=>m.childrenIndex),s.routesMeta.map(m=>m.childrenIndex)))}var Op=/^:[\w-]+$/,Ip=3,$p=2,zp=1,Dp=10,Mp=-2,hc=l=>l==="*";function Fp(l,u){let s=l.split("/"),m=s.length;return s.some(hc)&&(m+=Mp),u&&(m+=$p),s.filter(d=>!hc(d)).reduce((d,g)=>d+(Op.test(g)?Ip:g===""?zp:Dp),m)}function Ap(l,u){return l.length===u.length&&l.slice(0,-1).every((m,d)=>m===u[d])?l[l.length-1]-u[u.length-1]:0}function Up(l,u,s=!1){let{routesMeta:m}=l,d={},g="/",S=[];for(let E=0;E<m.length;++E){let k=m[E],x=E===m.length-1,j=g==="/"?u:u.slice(g.length)||"/",$=Xo({path:k.relativePath,caseSensitive:k.caseSensitive,end:x},j),N=k.route;if(!$&&x&&s&&!m[m.length-1].route.index&&($=Xo({path:k.relativePath,caseSensitive:k.caseSensitive,end:!1},j)),!$)return null;Object.assign(d,$.params),S.push({params:d,pathname:jt([g,$.pathname]),pathnameBase:Qp(jt([g,$.pathnameBase])),route:N}),$.pathnameBase!=="/"&&(g=jt([g,$.pathnameBase]))}return S}function Xo(l,u){typeof l=="string"&&(l={path:l,caseSensitive:!1,end:!0});let[s,m]=Bp(l.path,l.caseSensitive,l.end),d=u.match(s);if(!d)return null;let g=d[0],S=g.replace(/(.)\/+$/,"$1"),E=d.slice(1);return{params:m.reduce((x,{paramName:j,isOptional:$},N)=>{if(j==="*"){let O=E[N]||"";S=g.slice(0,g.length-O.length).replace(/(.)\/+$/,"$1")}const z=E[N];return $&&!z?x[j]=void 0:x[j]=(z||"").replace(/%2F/g,"/"),x},{}),pathname:g,pathnameBase:S,pattern:l}}function Bp(l,u=!1,s=!0){St(l==="*"||!l.endsWith("*")||l.endsWith("/*"),`Route path "${l}" will be treated as if it were "${l.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${l.replace(/\*$/,"/*")}".`);let m=[],d="^"+l.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(S,E,k)=>(m.push({paramName:E,isOptional:k!=null}),k?"/?([^\\/]+)?":"/([^\\/]+)"));return l.endsWith("*")?(m.push({paramName:"*"}),d+=l==="*"||l==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):s?d+="\\/*$":l!==""&&l!=="/"&&(d+="(?:(?=\\/|$))"),[new RegExp(d,u?void 0:"i"),m]}function Hp(l){try{return l.split("/").map(u=>decodeURIComponent(u).replace(/\//g,"%2F")).join("/")}catch(u){return St(!1,`The URL path "${l}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${u}).`),l}}function Zt(l,u){if(u==="/")return l;if(!l.toLowerCase().startsWith(u.toLowerCase()))return null;let s=u.endsWith("/")?u.length-1:u.length,m=l.charAt(s);return m&&m!=="/"?null:l.slice(s)||"/"}function Vp(l,u="/"){let{pathname:s,search:m="",hash:d=""}=typeof l=="string"?Un(l):l;return{pathname:s?s.startsWith("/")?s:Wp(s,u):u,search:Gp(m),hash:Kp(d)}}function Wp(l,u){let s=u.replace(/\/+$/,"").split("/");return l.split("/").forEach(d=>{d===".."?s.length>1&&s.pop():d!=="."&&s.push(d)}),s.length>1?s.join("/"):"/"}function Yl(l,u,s,m){return`Cannot include a '${l}' character in a manually specified \`to.${u}\` field [${JSON.stringify(m)}].  Please separate it out to the \`to.${s}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function qp(l){return l.filter((u,s)=>s===0||u.route.path&&u.route.path.length>0)}function xc(l){let u=qp(l);return u.map((s,m)=>m===u.length-1?s.pathname:s.pathnameBase)}function Sc(l,u,s,m=!1){let d;typeof l=="string"?d=Un(l):(d={...l},ve(!d.pathname||!d.pathname.includes("?"),Yl("?","pathname","search",d)),ve(!d.pathname||!d.pathname.includes("#"),Yl("#","pathname","hash",d)),ve(!d.search||!d.search.includes("#"),Yl("#","search","hash",d)));let g=l===""||d.pathname==="",S=g?"/":d.pathname,E;if(S==null)E=s;else{let $=u.length-1;if(!m&&S.startsWith("..")){let N=S.split("/");for(;N[0]==="..";)N.shift(),$-=1;d.pathname=N.join("/")}E=$>=0?u[$]:"/"}let k=Vp(d,E),x=S&&S!=="/"&&S.endsWith("/"),j=(g||S===".")&&s.endsWith("/");return!k.pathname.endsWith("/")&&(x||j)&&(k.pathname+="/"),k}var jt=l=>l.join("/").replace(/\/\/+/g,"/"),Qp=l=>l.replace(/\/+$/,"").replace(/^\/*/,"/"),Gp=l=>!l||l==="?"?"":l.startsWith("?")?l:"?"+l,Kp=l=>!l||l==="#"?"":l.startsWith("#")?l:"#"+l;function Xp(l){return l!=null&&typeof l.status=="number"&&typeof l.statusText=="string"&&typeof l.internal=="boolean"&&"data"in l}var Ec=["POST","PUT","PATCH","DELETE"];new Set(Ec);var Yp=["GET",...Ec];new Set(Yp);var Bn=_.createContext(null);Bn.displayName="DataRouter";var Yo=_.createContext(null);Yo.displayName="DataRouterState";var Cc=_.createContext({isTransitioning:!1});Cc.displayName="ViewTransition";var Jp=_.createContext(new Map);Jp.displayName="Fetchers";var Zp=_.createContext(null);Zp.displayName="Await";var Et=_.createContext(null);Et.displayName="Navigation";var jr=_.createContext(null);jr.displayName="Location";var Ot=_.createContext({outlet:null,matches:[],isDataRoute:!1});Ot.displayName="Route";var ra=_.createContext(null);ra.displayName="RouteError";function em(l,{relative:u}={}){ve(Or(),"useHref() may be used only in the context of a <Router> component.");let{basename:s,navigator:m}=_.useContext(Et),{hash:d,pathname:g,search:S}=Ir(l,{relative:u}),E=g;return s!=="/"&&(E=g==="/"?s:jt([s,g])),m.createHref({pathname:E,search:S,hash:d})}function Or(){return _.useContext(jr)!=null}function hn(){return ve(Or(),"useLocation() may be used only in the context of a <Router> component."),_.useContext(jr).location}var _c="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function Rc(l){_.useContext(Et).static||_.useLayoutEffect(l)}function tm(){let{isDataRoute:l}=_.useContext(Ot);return l?mm():nm()}function nm(){ve(Or(),"useNavigate() may be used only in the context of a <Router> component.");let l=_.useContext(Bn),{basename:u,navigator:s}=_.useContext(Et),{matches:m}=_.useContext(Ot),{pathname:d}=hn(),g=JSON.stringify(xc(m)),S=_.useRef(!1);return Rc(()=>{S.current=!0}),_.useCallback((k,x={})=>{if(St(S.current,_c),!S.current)return;if(typeof k=="number"){s.go(k);return}let j=Sc(k,JSON.parse(g),d,x.relative==="path");l==null&&u!=="/"&&(j.pathname=j.pathname==="/"?u:jt([u,j.pathname])),(x.replace?s.replace:s.push)(j,x.state,x)},[u,s,g,d,l])}_.createContext(null);function Ir(l,{relative:u}={}){let{matches:s}=_.useContext(Ot),{pathname:m}=hn(),d=JSON.stringify(xc(s));return _.useMemo(()=>Sc(l,JSON.parse(d),m,u==="path"),[l,d,m,u])}function rm(l,u){return bc(l,u)}function bc(l,u,s,m){var K;ve(Or(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:d,static:g}=_.useContext(Et),{matches:S}=_.useContext(Ot),E=S[S.length-1],k=E?E.params:{},x=E?E.pathname:"/",j=E?E.pathnameBase:"/",$=E&&E.route;{let W=$&&$.path||"";Pc(x,!$||W.endsWith("*")||W.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${x}" (under <Route path="${W}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${W}"> to <Route path="${W==="/"?"*":`${W}/*`}">.`)}let N=hn(),z;if(u){let W=typeof u=="string"?Un(u):u;ve(j==="/"||((K=W.pathname)==null?void 0:K.startsWith(j)),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${j}" but pathname "${W.pathname}" was given in the \`location\` prop.`),z=W}else z=N;let O=z.pathname||"/",A=O;if(j!=="/"){let W=j.replace(/^\//,"").split("/");A="/"+O.replace(/^\//,"").split("/").slice(W.length).join("/")}let I=!g&&s&&s.matches&&s.matches.length>0?s.matches:vc(l,{pathname:A});St($||I!=null,`No routes matched location "${z.pathname}${z.search}${z.hash}" `),St(I==null||I[I.length-1].route.element!==void 0||I[I.length-1].route.Component!==void 0||I[I.length-1].route.lazy!==void 0,`Matched leaf route at location "${z.pathname}${z.search}${z.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let D=sm(I&&I.map(W=>Object.assign({},W,{params:Object.assign({},k,W.params),pathname:jt([j,d.encodeLocation?d.encodeLocation(W.pathname).pathname:W.pathname]),pathnameBase:W.pathnameBase==="/"?j:jt([j,d.encodeLocation?d.encodeLocation(W.pathnameBase).pathname:W.pathnameBase])})),S,s,m);return u&&D?_.createElement(jr.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...z},navigationType:"POP"}},D):D}function om(){let l=pm(),u=Xp(l)?`${l.status} ${l.statusText}`:l instanceof Error?l.message:JSON.stringify(l),s=l instanceof Error?l.stack:null,m="rgba(200,200,200, 0.5)",d={padding:"0.5rem",backgroundColor:m},g={padding:"2px 4px",backgroundColor:m},S=null;return console.error("Error handled by React Router default ErrorBoundary:",l),S=_.createElement(_.Fragment,null,_.createElement("p",null,"💿 Hey developer 👋"),_.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",_.createElement("code",{style:g},"ErrorBoundary")," or"," ",_.createElement("code",{style:g},"errorElement")," prop on your route.")),_.createElement(_.Fragment,null,_.createElement("h2",null,"Unexpected Application Error!"),_.createElement("h3",{style:{fontStyle:"italic"}},u),s?_.createElement("pre",{style:d},s):null,S)}var im=_.createElement(om,null),lm=class extends _.Component{constructor(l){super(l),this.state={location:l.location,revalidation:l.revalidation,error:l.error}}static getDerivedStateFromError(l){return{error:l}}static getDerivedStateFromProps(l,u){return u.location!==l.location||u.revalidation!=="idle"&&l.revalidation==="idle"?{error:l.error,location:l.location,revalidation:l.revalidation}:{error:l.error!==void 0?l.error:u.error,location:u.location,revalidation:l.revalidation||u.revalidation}}componentDidCatch(l,u){console.error("React Router caught the following error during render",l,u)}render(){return this.state.error!==void 0?_.createElement(Ot.Provider,{value:this.props.routeContext},_.createElement(ra.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function am({routeContext:l,match:u,children:s}){let m=_.useContext(Bn);return m&&m.static&&m.staticContext&&(u.route.errorElement||u.route.ErrorBoundary)&&(m.staticContext._deepestRenderedBoundaryId=u.route.id),_.createElement(Ot.Provider,{value:l},s)}function sm(l,u=[],s=null,m=null){if(l==null){if(!s)return null;if(s.errors)l=s.matches;else if(u.length===0&&!s.initialized&&s.matches.length>0)l=s.matches;else return null}let d=l,g=s==null?void 0:s.errors;if(g!=null){let k=d.findIndex(x=>x.route.id&&(g==null?void 0:g[x.route.id])!==void 0);ve(k>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(g).join(",")}`),d=d.slice(0,Math.min(d.length,k+1))}let S=!1,E=-1;if(s)for(let k=0;k<d.length;k++){let x=d[k];if((x.route.HydrateFallback||x.route.hydrateFallbackElement)&&(E=k),x.route.id){let{loaderData:j,errors:$}=s,N=x.route.loader&&!j.hasOwnProperty(x.route.id)&&(!$||$[x.route.id]===void 0);if(x.route.lazy||N){S=!0,E>=0?d=d.slice(0,E+1):d=[d[0]];break}}}return d.reduceRight((k,x,j)=>{let $,N=!1,z=null,O=null;s&&($=g&&x.route.id?g[x.route.id]:void 0,z=x.route.errorElement||im,S&&(E<0&&j===0?(Pc("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),N=!0,O=null):E===j&&(N=!0,O=x.route.hydrateFallbackElement||null)));let A=u.concat(d.slice(0,j+1)),I=()=>{let D;return $?D=z:N?D=O:x.route.Component?D=_.createElement(x.route.Component,null):x.route.element?D=x.route.element:D=k,_.createElement(am,{match:x,routeContext:{outlet:k,matches:A,isDataRoute:s!=null},children:D})};return s&&(x.route.ErrorBoundary||x.route.errorElement||j===0)?_.createElement(lm,{location:s.location,revalidation:s.revalidation,component:z,error:$,children:I(),routeContext:{outlet:null,matches:A,isDataRoute:!0}}):I()},null)}function oa(l){return`${l} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function um(l){let u=_.useContext(Bn);return ve(u,oa(l)),u}function cm(l){let u=_.useContext(Yo);return ve(u,oa(l)),u}function dm(l){let u=_.useContext(Ot);return ve(u,oa(l)),u}function ia(l){let u=dm(l),s=u.matches[u.matches.length-1];return ve(s.route.id,`${l} can only be used on routes that contain a unique "id"`),s.route.id}function fm(){return ia("useRouteId")}function pm(){var m;let l=_.useContext(ra),u=cm("useRouteError"),s=ia("useRouteError");return l!==void 0?l:(m=u.errors)==null?void 0:m[s]}function mm(){let{router:l}=um("useNavigate"),u=ia("useNavigate"),s=_.useRef(!1);return Rc(()=>{s.current=!0}),_.useCallback(async(d,g={})=>{St(s.current,_c),s.current&&(typeof d=="number"?l.navigate(d):await l.navigate(d,{fromRouteId:u,...g}))},[l,u])}var gc={};function Pc(l,u,s){!u&&!gc[l]&&(gc[l]=!0,St(!1,s))}_.memo(hm);function hm({routes:l,future:u,state:s}){return bc(l,void 0,s,u)}function ea(l){ve(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function gm({basename:l="/",children:u=null,location:s,navigationType:m="POP",navigator:d,static:g=!1}){ve(!Or(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let S=l.replace(/^\/*/,"/"),E=_.useMemo(()=>({basename:S,navigator:d,static:g,future:{}}),[S,d,g]);typeof s=="string"&&(s=Un(s));let{pathname:k="/",search:x="",hash:j="",state:$=null,key:N="default"}=s,z=_.useMemo(()=>{let O=Zt(k,S);return O==null?null:{location:{pathname:O,search:x,hash:j,state:$,key:N},navigationType:m}},[S,k,x,j,$,N,m]);return St(z!=null,`<Router basename="${S}"> is not able to match the URL "${k}${x}${j}" because it does not start with the basename, so the <Router> won't render anything.`),z==null?null:_.createElement(Et.Provider,{value:E},_.createElement(jr.Provider,{children:u,value:z}))}function ym({children:l,location:u}){return rm(ta(l),u)}function ta(l,u=[]){let s=[];return _.Children.forEach(l,(m,d)=>{if(!_.isValidElement(m))return;let g=[...u,d];if(m.type===_.Fragment){s.push.apply(s,ta(m.props.children,g));return}ve(m.type===ea,`[${typeof m.type=="string"?m.type:m.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),ve(!m.props.index||!m.props.children,"An index route cannot have child routes.");let S={id:m.props.id||g.join("-"),caseSensitive:m.props.caseSensitive,element:m.props.element,Component:m.props.Component,index:m.props.index,path:m.props.path,loader:m.props.loader,action:m.props.action,hydrateFallbackElement:m.props.hydrateFallbackElement,HydrateFallback:m.props.HydrateFallback,errorElement:m.props.errorElement,ErrorBoundary:m.props.ErrorBoundary,hasErrorBoundary:m.props.hasErrorBoundary===!0||m.props.ErrorBoundary!=null||m.props.errorElement!=null,shouldRevalidate:m.props.shouldRevalidate,handle:m.props.handle,lazy:m.props.lazy};m.props.children&&(S.children=ta(m.props.children,g)),s.push(S)}),s}var Go="get",Ko="application/x-www-form-urlencoded";function Jo(l){return l!=null&&typeof l.tagName=="string"}function vm(l){return Jo(l)&&l.tagName.toLowerCase()==="button"}function wm(l){return Jo(l)&&l.tagName.toLowerCase()==="form"}function km(l){return Jo(l)&&l.tagName.toLowerCase()==="input"}function xm(l){return!!(l.metaKey||l.altKey||l.ctrlKey||l.shiftKey)}function Sm(l,u){return l.button===0&&(!u||u==="_self")&&!xm(l)}var Qo=null;function Em(){if(Qo===null)try{new FormData(document.createElement("form"),0),Qo=!1}catch{Qo=!0}return Qo}var Cm=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function Jl(l){return l!=null&&!Cm.has(l)?(St(!1,`"${l}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Ko}"`),null):l}function _m(l,u){let s,m,d,g,S;if(wm(l)){let E=l.getAttribute("action");m=E?Zt(E,u):null,s=l.getAttribute("method")||Go,d=Jl(l.getAttribute("enctype"))||Ko,g=new FormData(l)}else if(vm(l)||km(l)&&(l.type==="submit"||l.type==="image")){let E=l.form;if(E==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let k=l.getAttribute("formaction")||E.getAttribute("action");if(m=k?Zt(k,u):null,s=l.getAttribute("formmethod")||E.getAttribute("method")||Go,d=Jl(l.getAttribute("formenctype"))||Jl(E.getAttribute("enctype"))||Ko,g=new FormData(E,l),!Em()){let{name:x,type:j,value:$}=l;if(j==="image"){let N=x?`${x}.`:"";g.append(`${N}x`,"0"),g.append(`${N}y`,"0")}else x&&g.append(x,$)}}else{if(Jo(l))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');s=Go,m=null,d=Ko,S=l}return g&&d==="text/plain"&&(S=g,g=void 0),{action:m,method:s.toLowerCase(),encType:d,formData:g,body:S}}function la(l,u){if(l===!1||l===null||typeof l>"u")throw new Error(u)}async function Rm(l,u){if(l.id in u)return u[l.id];try{let s=await import(l.module);return u[l.id]=s,s}catch(s){return console.error(`Error loading route module \`${l.module}\`, reloading page...`),console.error(s),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function bm(l){return l==null?!1:l.href==null?l.rel==="preload"&&typeof l.imageSrcSet=="string"&&typeof l.imageSizes=="string":typeof l.rel=="string"&&typeof l.href=="string"}async function Pm(l,u,s){let m=await Promise.all(l.map(async d=>{let g=u.routes[d.route.id];if(g){let S=await Rm(g,s);return S.links?S.links():[]}return[]}));return jm(m.flat(1).filter(bm).filter(d=>d.rel==="stylesheet"||d.rel==="preload").map(d=>d.rel==="stylesheet"?{...d,rel:"prefetch",as:"style"}:{...d,rel:"prefetch"}))}function yc(l,u,s,m,d,g){let S=(k,x)=>s[x]?k.route.id!==s[x].route.id:!0,E=(k,x)=>{var j;return s[x].pathname!==k.pathname||((j=s[x].route.path)==null?void 0:j.endsWith("*"))&&s[x].params["*"]!==k.params["*"]};return g==="assets"?u.filter((k,x)=>S(k,x)||E(k,x)):g==="data"?u.filter((k,x)=>{var $;let j=m.routes[k.route.id];if(!j||!j.hasLoader)return!1;if(S(k,x)||E(k,x))return!0;if(k.route.shouldRevalidate){let N=k.route.shouldRevalidate({currentUrl:new URL(d.pathname+d.search+d.hash,window.origin),currentParams:(($=s[0])==null?void 0:$.params)||{},nextUrl:new URL(l,window.origin),nextParams:k.params,defaultShouldRevalidate:!0});if(typeof N=="boolean")return N}return!0}):[]}function Nm(l,u){return Lm(l.map(s=>{let m=u.routes[s.route.id];if(!m)return[];let d=[m.module];return m.imports&&(d=d.concat(m.imports)),d}).flat(1))}function Lm(l){return[...new Set(l)]}function Tm(l){let u={},s=Object.keys(l).sort();for(let m of s)u[m]=l[m];return u}function jm(l,u){let s=new Set;return new Set(u),l.reduce((m,d)=>{let g=JSON.stringify(Tm(d));return s.has(g)||(s.add(g),m.push({key:g,link:d})),m},[])}function Om(l){let u=typeof l=="string"?new URL(l,typeof window>"u"?"server://singlefetch/":window.location.origin):l;return u.pathname==="/"?u.pathname="_root.data":u.pathname=`${u.pathname.replace(/\/$/,"")}.data`,u}function Im(){let l=_.useContext(Bn);return la(l,"You must render this element inside a <DataRouterContext.Provider> element"),l}function $m(){let l=_.useContext(Yo);return la(l,"You must render this element inside a <DataRouterStateContext.Provider> element"),l}var aa=_.createContext(void 0);aa.displayName="FrameworkContext";function Nc(){let l=_.useContext(aa);return la(l,"You must render this element inside a <HydratedRouter> element"),l}function zm(l,u){let s=_.useContext(aa),[m,d]=_.useState(!1),[g,S]=_.useState(!1),{onFocus:E,onBlur:k,onMouseEnter:x,onMouseLeave:j,onTouchStart:$}=u,N=_.useRef(null);_.useEffect(()=>{if(l==="render"&&S(!0),l==="viewport"){let A=D=>{D.forEach(K=>{S(K.isIntersecting)})},I=new IntersectionObserver(A,{threshold:.5});return N.current&&I.observe(N.current),()=>{I.disconnect()}}},[l]),_.useEffect(()=>{if(m){let A=setTimeout(()=>{S(!0)},100);return()=>{clearTimeout(A)}}},[m]);let z=()=>{d(!0)},O=()=>{d(!1),S(!1)};return s?l!=="intent"?[g,N,{}]:[g,N,{onFocus:Lr(E,z),onBlur:Lr(k,O),onMouseEnter:Lr(x,z),onMouseLeave:Lr(j,O),onTouchStart:Lr($,z)}]:[!1,N,{}]}function Lr(l,u){return s=>{l&&l(s),s.defaultPrevented||u(s)}}function Dm({page:l,...u}){let{router:s}=Im(),m=_.useMemo(()=>vc(s.routes,l,s.basename),[s.routes,l,s.basename]);return m?_.createElement(Fm,{page:l,matches:m,...u}):null}function Mm(l){let{manifest:u,routeModules:s}=Nc(),[m,d]=_.useState([]);return _.useEffect(()=>{let g=!1;return Pm(l,u,s).then(S=>{g||d(S)}),()=>{g=!0}},[l,u,s]),m}function Fm({page:l,matches:u,...s}){let m=hn(),{manifest:d,routeModules:g}=Nc(),{loaderData:S,matches:E}=$m(),k=_.useMemo(()=>yc(l,u,E,d,m,"data"),[l,u,E,d,m]),x=_.useMemo(()=>yc(l,u,E,d,m,"assets"),[l,u,E,d,m]),j=_.useMemo(()=>{if(l===m.pathname+m.search+m.hash)return[];let z=new Set,O=!1;if(u.forEach(I=>{var K;let D=d.routes[I.route.id];!D||!D.hasLoader||(!k.some(W=>W.route.id===I.route.id)&&I.route.id in S&&((K=g[I.route.id])!=null&&K.shouldRevalidate)||D.hasClientLoader?O=!0:z.add(I.route.id))}),z.size===0)return[];let A=Om(l);return O&&z.size>0&&A.searchParams.set("_routes",u.filter(I=>z.has(I.route.id)).map(I=>I.route.id).join(",")),[A.pathname+A.search]},[S,m,d,k,u,l,g]),$=_.useMemo(()=>Nm(x,d),[x,d]),N=Mm(x);return _.createElement(_.Fragment,null,j.map(z=>_.createElement("link",{key:z,rel:"prefetch",as:"fetch",href:z,...s})),$.map(z=>_.createElement("link",{key:z,rel:"modulepreload",href:z,...s})),N.map(({key:z,link:O})=>_.createElement("link",{key:z,...O})))}function Am(...l){return u=>{l.forEach(s=>{typeof s=="function"?s(u):s!=null&&(s.current=u)})}}var Lc=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{Lc&&(window.__reactRouterVersion="7.1.5")}catch{}function Um({basename:l,children:u,window:s}){let m=_.useRef();m.current==null&&(m.current=Pp({window:s,v5Compat:!0}));let d=m.current,[g,S]=_.useState({action:d.action,location:d.location}),E=_.useCallback(k=>{_.startTransition(()=>S(k))},[S]);return _.useLayoutEffect(()=>d.listen(E),[d,E]),_.createElement(gm,{basename:l,children:u,location:g.location,navigationType:g.action,navigator:d})}var Tc=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,sa=_.forwardRef(function({onClick:u,discover:s="render",prefetch:m="none",relative:d,reloadDocument:g,replace:S,state:E,target:k,to:x,preventScrollReset:j,viewTransition:$,...N},z){let{basename:O}=_.useContext(Et),A=typeof x=="string"&&Tc.test(x),I,D=!1;if(typeof x=="string"&&A&&(I=x,Lc))try{let ke=new URL(window.location.href),Ne=x.startsWith("//")?new URL(ke.protocol+x):new URL(x),mt=Zt(Ne.pathname,O);Ne.origin===ke.origin&&mt!=null?x=mt+Ne.search+Ne.hash:D=!0}catch{St(!1,`<Link to="${x}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let K=em(x,{relative:d}),[W,te,se]=zm(m,N),we=Wm(x,{replace:S,state:E,target:k,preventScrollReset:j,relative:d,viewTransition:$});function he(ke){u&&u(ke),ke.defaultPrevented||we(ke)}let _e=_.createElement("a",{...N,...se,href:I||K,onClick:D||g?u:he,ref:Am(z,te),target:k,"data-discover":!A&&s==="render"?"true":void 0});return W&&!A?_.createElement(_.Fragment,null,_e,_.createElement(Dm,{page:K})):_e});sa.displayName="Link";var Bm=_.forwardRef(function({"aria-current":u="page",caseSensitive:s=!1,className:m="",end:d=!1,style:g,to:S,viewTransition:E,children:k,...x},j){let $=Ir(S,{relative:x.relative}),N=hn(),z=_.useContext(Yo),{navigator:O,basename:A}=_.useContext(Et),I=z!=null&&Xm($)&&E===!0,D=O.encodeLocation?O.encodeLocation($).pathname:$.pathname,K=N.pathname,W=z&&z.navigation&&z.navigation.location?z.navigation.location.pathname:null;s||(K=K.toLowerCase(),W=W?W.toLowerCase():null,D=D.toLowerCase()),W&&A&&(W=Zt(W,A)||W);const te=D!=="/"&&D.endsWith("/")?D.length-1:D.length;let se=K===D||!d&&K.startsWith(D)&&K.charAt(te)==="/",we=W!=null&&(W===D||!d&&W.startsWith(D)&&W.charAt(D.length)==="/"),he={isActive:se,isPending:we,isTransitioning:I},_e=se?u:void 0,ke;typeof m=="function"?ke=m(he):ke=[m,se?"active":null,we?"pending":null,I?"transitioning":null].filter(Boolean).join(" ");let Ne=typeof g=="function"?g(he):g;return _.createElement(sa,{...x,"aria-current":_e,className:ke,ref:j,style:Ne,to:S,viewTransition:E},typeof k=="function"?k(he):k)});Bm.displayName="NavLink";var Hm=_.forwardRef(({discover:l="render",fetcherKey:u,navigate:s,reloadDocument:m,replace:d,state:g,method:S=Go,action:E,onSubmit:k,relative:x,preventScrollReset:j,viewTransition:$,...N},z)=>{let O=Gm(),A=Km(E,{relative:x}),I=S.toLowerCase()==="get"?"get":"post",D=typeof E=="string"&&Tc.test(E),K=W=>{if(k&&k(W),W.defaultPrevented)return;W.preventDefault();let te=W.nativeEvent.submitter,se=(te==null?void 0:te.getAttribute("formmethod"))||S;O(te||W.currentTarget,{fetcherKey:u,method:se,navigate:s,replace:d,state:g,relative:x,preventScrollReset:j,viewTransition:$})};return _.createElement("form",{ref:z,method:I,action:A,onSubmit:m?k:K,...N,"data-discover":!D&&l==="render"?"true":void 0})});Hm.displayName="Form";function Vm(l){return`${l} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function jc(l){let u=_.useContext(Bn);return ve(u,Vm(l)),u}function Wm(l,{target:u,replace:s,state:m,preventScrollReset:d,relative:g,viewTransition:S}={}){let E=tm(),k=hn(),x=Ir(l,{relative:g});return _.useCallback(j=>{if(Sm(j,u)){j.preventDefault();let $=s!==void 0?s:Tr(k)===Tr(x);E(l,{replace:$,state:m,preventScrollReset:d,relative:g,viewTransition:S})}},[k,E,x,s,m,u,l,d,g,S])}var qm=0,Qm=()=>`__${String(++qm)}__`;function Gm(){let{router:l}=jc("useSubmit"),{basename:u}=_.useContext(Et),s=fm();return _.useCallback(async(m,d={})=>{let{action:g,method:S,encType:E,formData:k,body:x}=_m(m,u);if(d.navigate===!1){let j=d.fetcherKey||Qm();await l.fetch(j,s,d.action||g,{preventScrollReset:d.preventScrollReset,formData:k,body:x,formMethod:d.method||S,formEncType:d.encType||E,flushSync:d.flushSync})}else await l.navigate(d.action||g,{preventScrollReset:d.preventScrollReset,formData:k,body:x,formMethod:d.method||S,formEncType:d.encType||E,replace:d.replace,state:d.state,fromRouteId:s,flushSync:d.flushSync,viewTransition:d.viewTransition})},[l,u,s])}function Km(l,{relative:u}={}){let{basename:s}=_.useContext(Et),m=_.useContext(Ot);ve(m,"useFormAction must be used inside a RouteContext");let[d]=m.matches.slice(-1),g={...Ir(l||".",{relative:u})},S=hn();if(l==null){g.search=S.search;let E=new URLSearchParams(g.search),k=E.getAll("index");if(k.some(j=>j==="")){E.delete("index"),k.filter($=>$).forEach($=>E.append("index",$));let j=E.toString();g.search=j?`?${j}`:""}}return(!l||l===".")&&d.route.index&&(g.search=g.search?g.search.replace(/^\?/,"?index&"):"?index"),s!=="/"&&(g.pathname=g.pathname==="/"?s:jt([s,g.pathname])),Tr(g)}function Xm(l,u={}){let s=_.useContext(Cc);ve(s!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:m}=jc("useViewTransitionState"),d=Ir(l,{relative:u.relative});if(!s.isTransitioning)return!1;let g=Zt(s.currentLocation.pathname,m)||s.currentLocation.pathname,S=Zt(s.nextLocation.pathname,m)||s.nextLocation.pathname;return Xo(d.pathname,S)!=null||Xo(d.pathname,g)!=null}new TextEncoder;function Ym(){return C.jsxs("div",{className:"flex min-h-screen flex-col items-center justify-center bg-gray-100 p-6 text-center",children:[C.jsx("h1",{className:"text-6xl font-bold text-gray-800",children:"404"}),C.jsx("p",{className:"mt-2 text-lg text-gray-600",children:"Page Not Found"}),C.jsx(sa,{to:"/",className:"mt-4 text-blue-500 hover:underline",children:"Go Back Home"})]})}function Jm(){return C.jsx(C.Fragment,{children:C.jsx(Um,{children:C.jsxs(ym,{children:[C.jsx(ea,{path:"/",element:C.jsx(Rp,{})}),C.jsx(ea,{path:"*",element:C.jsx(Ym,{})})]})})})}Mf.createRoot(document.getElementById("root")).render(C.jsx(_.StrictMode,{children:C.jsx(Jm,{})}));
