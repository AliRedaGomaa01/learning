 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ic;function Tf(){if(ic)return Pr;ic=1;var l=na(),u=Symbol.for("react.element"),s=Symbol.for("react.fragment"),m=Object.prototype.hasOwnProperty,d=l.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,g={key:!0,ref:!0,__self:!0,__source:!0};function S(E,k,x){var j,$={},N=null,z=null;x!==void 0&&(N=""+x),k.key!==void 0&&(N=""+k.key),k.ref!==void 0&&(z=k.ref);for(j in k)m.call(k,j)&&!g.hasOwnProperty(j)&&($[j]=k[j]);if(E&&E.defaultProps)for(j in k=E.defaultProps,k)$[j]===void 0&&($[j]=k[j]);return{$$typeof:u,type:E,key:N,ref:z,props:$,_owner:d.current}}return Pr.Fragment=s,Pr.jsx=S,Pr.jsxs=S,Pr}var lc;function jf(){return lc||(lc=1,ql.exports=Tf()),ql.exports}var C=jf(),R=na(),qo={},Gl={exports:{}},Qe={},Kl={exports:{}},Xl={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ac;function Of(){return ac||(ac=1,function(l){function u(D,X){var B=D.length;D.push(X);e:for(;0<B;){var h=B-1>>>1,b=D[h];if(0<d(b,X))D[h]=X,D[B]=b,B=h;else break e}}function s(D){return D.length===0?null:D[0]}function m(D){if(D.length===0)return null;var X=D[0],B=D.pop();if(B!==X){D[0]=B;e:for(var h=0,b=D.length,J=b>>>1;h<J;){var ee=2*(h+1)-1,re=D[ee],oe=ee+1,ue=D[oe];if(0>d(re,B))oe<b&&0>d(ue,re)?(D[h]=ue,D[oe]=B,h=oe):(D[h]=re,D[ee]=B,h=ee);else if(oe<b&&0>d(ue,B))D[h]=ue,D[oe]=B,h=oe;else break e}}return X}function d(D,X){var B=D.sortIndex-X.sortIndex;return B!==0?B:D.id-X.id}if(typeof performance=="object"&&typeof performance.now=="function"){var g=performance;l.unstable_now=function(){return g.now()}}else{var S=Date,E=S.now();l.unstable_now=function(){return S.now()-E}}var k=[],x=[],j=1,$=null,N=3,z=!1,O=!1,A=!1,I=typeof setTimeout=="function"?setTimeout:null,M=typeof clearTimeout=="function"?clearTimeout:null,K=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function W(D){for(var X=s(x);X!==null;){if(X.callback===null)m(x);else if(X.startTime<=D)m(x),X.sortIndex=X.expirationTime,u(k,X);else break;X=s(x)}}function te(D){if(A=!1,W(D),!O)if(s(k)!==null)O=!0,Ue(se);else{var X=s(x);X!==null&&xe(te,X.startTime-D)}}function se(D,X){O=!1,A&&(A=!1,M(Re),Re=-1),z=!0;var B=N;try{for(W(X),$=s(k);$!==null&&(!($.expirationTime>X)||D&&!mt());){var h=$.callback;if(typeof h=="function"){$.callback=null,N=$.priorityLevel;var b=h($.expirationTime<=X);X=l.unstable_now(),typeof b=="function"?$.callback=b:$===s(k)&&m(k),W(X)}else m(k);$=s(k)}if($!==null)var J=!0;else{var ee=s(x);ee!==null&&xe(te,ee.startTime-X),J=!1}return J}finally{$=null,N=B,z=!1}}var we=!1,he=null,Re=-1,ke=5,Ne=-1;function mt(){return!(l.unstable_now()-Ne<ke)}function ht(){if(he!==null){var D=l.unstable_now();Ne=D;var X=!0;try{X=he(!0,D)}finally{X?Ge():(we=!1,he=null)}}else we=!1}var Ge;if(typeof K=="function")Ge=function(){K(ht)};else if(typeof MessageChannel<"u"){var lt=new MessageChannel,gt=lt.port2;lt.port1.onmessage=ht,Ge=function(){gt.postMessage(null)}}else Ge=function(){I(ht,0)};function Ue(D){he=D,we||(we=!0,Ge())}function xe(D,X){Re=I(function(){D(l.unstable_now())},X)}l.unstable_IdlePriority=5,l.unstable_ImmediatePriority=1,l.unstable_LowPriority=4,l.unstable_NormalPriority=3,l.unstable_Profiling=null,l.unstable_UserBlockingPriority=2,l.unstable_cancelCallback=function(D){D.callback=null},l.unstable_continueExecution=function(){O||z||(O=!0,Ue(se))},l.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ke=0<D?Math.floor(1e3/D):5},l.unstable_getCurrentPriorityLevel=function(){return N},l.unstable_getFirstCallbackNode=function(){return s(k)},l.unstable_next=function(D){switch(N){case 1:case 2:case 3:var X=3;break;default:X=N}var B=N;N=X;try{return D()}finally{N=B}},l.unstable_pauseExecution=function(){},l.unstable_requestPaint=function(){},l.unstable_runWithPriority=function(D,X){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var B=N;N=D;try{return X()}finally{N=B}},l.unstable_scheduleCallback=function(D,X,B){var h=l.unstable_now();switch(typeof B=="object"&&B!==null?(B=B.delay,B=typeof B=="number"&&0<B?h+B:h):B=h,D){case 1:var b=-1;break;case 2:b=250;break;case 5:b=1073741823;break;case 4:b=1e4;break;default:b=5e3}return b=B+b,D={id:j++,callback:X,priorityLevel:D,startTime:B,expirationTime:b,sortIndex:-1},B>h?(D.sortIndex=B,u(x,D),s(k)===null&&D===s(x)&&(A?(M(Re),Re=-1):A=!0,xe(te,B-h))):(D.sortIndex=b,u(k,D),O||z||(O=!0,Ue(se))),D},l.unstable_shouldYield=mt,l.unstable_wrapCallback=function(D){var X=N;return function(){var B=N;N=X;try{return D.apply(this,arguments)}finally{N=B}}}}(Xl)),Xl}var sc;function If(){return sc||(sc=1,Kl.exports=Of()),Kl.exports}/**
 * @license React
...
# define types
  ...
  * generic ( general not specific ) 
    ...
    - Ex
      ...
      `})}function Xf(){const l=["Web Basics","Github","Theoretical","Design","Css","Tailwind","OOP","Javascript","Typescript"],[u,s]=R.useState("Web Basics");return C.jsxs(C.Fragment,{children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Web Basics"&&C.jsx(Ff,{}),u==="Github"&&C.jsx(Af,{}),u==="Theoretical"&&C.jsx(Uf,{}),u==="Design"&&C.jsx(Bf,{}),u==="Css"&&C.jsx(Vf,{}),u==="Bootstrap"&&C.jsx(Hf,{}),u==="Tailwind"&&C.jsx(Wf,{}),u==="Sass"&&C.jsx(qf,{}),u==="OOP"&&C.jsx(Qf,{}),u==="Javascript"&&C.jsx(Gf,{}),u==="Typescript"&&C.jsx(Kf,{})]})}function Yf(){return C.jsx("pre",{children:`
# Authentication
...
*****************
  ...
  * blade template engine :
    ...
    * forms : 
      ...
      `})}function ap(){const l=["Common","Common Web","React","Next","Vue","Angular","Laravel","Common Mobile","Flutter","React Native"],[u,s]=R.useState("Common");return C.jsxs(C.Fragment,{children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Common"&&C.jsx(Yf,{}),u==="Common Mobile"&&C.jsx(Jf,{}),u==="Common Web"&&C.jsx(Zf,{}),u==="React"&&C.jsx(ep,{}),u==="Next"&&C.jsx(tp,{}),u==="Vue"&&C.jsx(np,{}),u==="Angular"&&C.jsx(rp,{}),u==="Laravel"&&C.jsx(lp,{}),u==="Flutter"&&C.jsx(op,{}),u==="React Native"&&C.jsx(ip,{})]})}function sp(){return C.jsx("pre",{children:`    
# basics info
...
`})}function fp(){const l=["Common","Express","Laravel"],[u,s]=R.useState("Common");return C.jsxs(C.Fragment,{children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Common"&&C.jsx(sp,{}),u==="Django"&&C.jsx(up,{}),u==="Express"&&C.jsx(cp,{}),u==="Laravel"&&C.jsx(dp,{})]})}function pp(){return C.jsx("pre",{children:`
# Basics Info
...
# performance :
  * use relations & reduce storing as json
      ...
      `})}function yp(){const l=["Common","Express","Laravel"],[u,s]=R.useState("Common");return C.jsxs(C.Fragment,{children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Common"&&C.jsx(pp,{}),u==="Django"&&C.jsx(mp,{}),u==="Express"&&C.jsx(hp,{}),u==="Laravel"&&C.jsx(gp,{})]})}function vp(){return C.jsx("pre",{children:`
# important info
...
<IfModule mod_rewrite.c>
  ...
  RewriteRule ^(.*) /index.html [NC,L]
      ...
      `})}function kp(){const l=["Web","Mobile"],[u,s]=R.useState("Web");return C.jsxs(C.Fragment,{children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Web"&&C.jsx(wp,{}),u==="Mobile"&&C.jsx(vp,{})]})}function xp(){return C.jsx("pre",{children:`
...
* marketing tools : 
  - email : mailchimp
`});function Cp(){const l=["Common","CMS","SEO"],[u,s]=R.useState("Common");return C.jsxs(C.Fragment,{children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Common"&&C.jsx(xp,{}),u==="CMS"&&C.jsx(Sp,{}),u==="SEO"&&C.jsx(Ep,{})]})}function Rp(){const l=["Basics","Frontend","Backend","Database","Deployment","Marketing"],[u,s]=R.useState("Basics");return C.jsx(C.Fragment,{children:C.jsx("div",{className:"min-h-screen min-w-screen box-border p-2 md:p-5 flex flex-col",children:C.jsxs("div",{className:"border-8 border-black h-full w-full relative grow p-2 md:p-5 flex flex-col gap-5",children:[C.jsx(mn,{list:l,selectedItem:u,setSelectedItem:s}),u==="Basics"&&C.jsx(Xf,{}),u==="Frontend"&&C.jsx(ap,{}),u==="Backend"&&C.jsx(fp,{}),u==="Database"&&C.jsx(yp,{}),u==="Deployment"&&C.jsx(kp,{}),u==="Marketing"&&C.jsx(Cp,{})]})})})}var Nr={},fc;function _p(){if(fc)return Nr;fc=1,Object.defineProperty(Nr,"__esModule",{value:!0}),Nr.parse=S,Nr.serialize=x;const l=/^[\u0021-\u003A\u003C\u003E-\u007E]+$/,u=/^[\u0021-\u003A\u003C-\u007E]*$/,s=/^([.]?[a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)([.][a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)*$/i,m=/^[\u0020-\u003A\u003D-\u007E]*$/,d=Object.prototype.toString,g=(()=>{const N=function(){};return N.prototype=Object.create(null),N})();function S(N,z){const O=new g,A=N.length;if(A<2)return O;const I=(z==null?void 0:z.decode)||j;let M=0;do{const K=N.indexOf("=",M);if(K===-1)break;const W=N.indexOf(";",M),te=W===-1?A:W;if(K>te){M=N.lastIndexOf(";",K-1)+1;continue}const se=E(N,M,K),we=k(N,K,se),he=N.slice(se,we);if(O[he]===void 0){let Re=E(N,K+1,te),ke=k(N,te,Re);const Ne=I(N.slice(Re,ke));O[he]=Ne}M=te+1}while(M<A);return O}function E(N,z,O){do{const A=N.charCodeAt(z);if(A!==32&&A!==9)return z}while(++z<O);return O}function k(N,z,O){for(;z>O;){const A=N.charCodeAt(--z);if(A!==32&&A!==9)return z+1}return O}function x(N,z,O){const A=(O==null?void 0:O.encode)||encodeURIComponent;if(!l.test(N))throw new TypeError(`argument name is invalid: ${N}`);const I=A(z);if(!u.test(I))throw new TypeError(`argument val is invalid: ${z}`);let M=N+"="+I;if(!O)return M;if(O.maxAge!==void 0){if(!Number.isInteger(O.maxAge))throw new TypeError(`option maxAge is invalid: ${O.maxAge}`);M+="; Max-Age="+O.maxAge}if(O.domain){if(!s.test(O.domain))throw new TypeError(`option domain is invalid: ${O.domain}`);M+="; Domain="+O.domain}if(O.path){if(!m.test(O.path))throw new TypeError(`option path is invalid: ${O.path}`);M+="; Path="+O.path}if(O.expires){if(!$(O.expires)||!Number.isFinite(O.expires.valueOf()))throw new TypeError(`option expires is invalid: ${O.expires}`);M+="; Expires="+O.expires.toUTCString()}if(O.httpOnly&&(M+="; HttpOnly"),O.secure&&(M+="; Secure"),O.partitioned&&(M+="; Partitioned"),O.priority)switch(typeof O.priority=="string"?O.priority.toLowerCase():void 0){case"low":M+="; Priority=Low";break;case"medium":M+="; Priority=Medium";break;case"high":M+="; Priority=High";break;default:throw new TypeError(`option priority is invalid: ${O.priority}`)}if(O.sameSite)switch(typeof O.sameSite=="string"?O.sameSite.toLowerCase():O.sameSite){case!0:case"strict":M+="; SameSite=Strict";break;case"lax":M+="; SameSite=Lax";break;case"none":M+="; SameSite=None";break;default:throw new TypeError(`option sameSite is invalid: ${O.sameSite}`)}return M}function j(N){if(N.indexOf("%")===-1)return N;try{return decodeURIComponent(N)}catch{return N}}function $(N){return d.call(N)==="[object Date]"}return Nr}_p();/**
 * react-router v7.1.5
 *
 ...
 *
 * @license MIT
 */var pc="popstate";function bp(l={}){function u(m,d){let{pathname:g,search:S,hash:E}=m.location;return Zl("",{pathname:g,search:S,hash:E},d.state&&d.state.usr||null,d.state&&d.state.key||"default")}function s(m,d){return typeof d=="string"?d:Tr(d)}return Np(u,s,null,l)}function ve(l,u){if(l===!1||l===null||typeof l>"u")throw new Error(u)}function St(l,u){if(!l){typeof console<"u"&&console.warn(u);try{throw new Error(u)}catch{}}}function Pp(){return Math.random().toString(36).substring(2,10)}function mc(l,u){return{usr:l.state,key:l.key,idx:u}}function Zl(l,u,s=null,m){return{pathname:typeof l=="string"?l:l.pathname,search:"",hash:"",...typeof u=="string"?Un(u):u,state:s,key:u&&u.key||m||Pp()}}function Tr({pathname:l="/",search:u="",hash:s=""}){return u&&u!=="?"&&(l+=u.charAt(0)==="?"?u:"?"+u),s&&s!=="#"&&(l+=s.charAt(0)==="#"?s:"#"+s),l}function Un(l){let u={};if(l){let s=l.indexOf("#");s>=0&&(u.hash=l.substring(s),l=l.substring(0,s));let m=l.indexOf("?");m>=0&&(u.search=l.substring(m),l=l.substring(0,m)),l&&(u.pathname=l)}return u}function Np(l,u,s,m={}){let{window:d=document.defaultView,v5Compat:g=!1}=m,S=d.history,E="POP",k=null,x=j();x==null&&(x=0,S.replaceState({...S.state,idx:x},""));function j(){return(S.state||{idx:null}).idx}function $(){E="POP";let I=j(),M=I==null?null:I-x;x=I,k&&k({action:E,location:A.location,delta:M})}function N(I,M){E="PUSH";let K=Zl(A.location,I,M);x=j()+1;let W=mc(K,x),te=A.createHref(K);try{S.pushState(W,"",te)}catch(se){if(se instanceof DOMException&&se.name==="DataCloneError")throw se;d.location.assign(te)}g&&k&&k({action:E,location:A.location,delta:1})}function z(I,M){E="REPLACE";let K=Zl(A.location,I,M);x=j();let W=mc(K,x),te=A.createHref(K);S.replaceState(W,"",te),g&&k&&k({action:E,location:A.location,delta:0})}function O(I){let M=d.location.origin!=="null"?d.location.origin:d.location.href,K=typeof I=="string"?I:Tr(I);return K=K.replace(/ $/,"%20"),ve(M,`No window.location.(origin|href) available to create URL for href: ${K}`),new URL(K,M)}let A={get action(){return E},get location(){return l(d,S)},listen(I){if(k)throw new Error("A history only accepts one active listener");return d.addEventListener(pc,$),k=I,()=>{d.removeEventListener(pc,$),k=null}},createHref(I){return u(d,I)},createURL:O,encodeLocation(I){let M=O(I);return{pathname:M.pathname,search:M.search,hash:M.hash}},push:N,replace:z,go(I){return S.go(I)}};return A}function vc(l,u,s="/"){return Lp(l,u,s,!1)}function Lp(l,u,s,m){let d=typeof u=="string"?Un(u):u,g=Zt(d.pathname||"/",s);if(g==null)return null;let S=wc(l);Tp(S);let E=null;for(let k=0;E==null&&k<S.length;++k){let x=Bp(g);E=Ap(S[k],x,m)}return E}function wc(l,u=[],s=[],m=""){let d=(g,S,E)=>{let k={relativePath:E===void 0?g.path||"":E,caseSensitive:g.caseSensitive===!0,childrenIndex:S,route:g};k.relativePath.startsWith("/")&&(ve(k.relativePath.startsWith(m),`Absolute route path "${k.relativePath}" nested under path "${m}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),k.relativePath=k.relativePath.slice(m.length));let x=jt([m,k.relativePath]),j=s.concat(k);g.children&&g.children.length>0&&(ve(g.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${x}".`),wc(g.children,u,j,x)),!(g.path==null&&!g.index)&&u.push({path:x,score:Dp(x,g.index),routesMeta:j})};return l.forEach((g,S)=>{var E;if(g.path===""||!((E=g.path)!=null&&E.includes("?")))d(g,S);else for(let k of kc(g.path))d(g,S,k)}),u}function kc(l){let u=l.split("/");if(u.length===0)return[];let[s,...m]=u,d=s.endsWith("?"),g=s.replace(/\?$/,"");if(m.length===0)return d?[g,""]:[g];let S=kc(m.join("/")),E=[];return E.push(...S.map(k=>k===""?g:[g,k].join("/"))),d&&E.push(...S),E.map(k=>l.startsWith("/")&&k===""?"/":k)}function Tp(l){l.sort((u,s)=>u.score!==s.score?s.score-u.score:Fp(u.routesMeta.map(m=>m.childrenIndex),s.routesMeta.map(m=>m.childrenIndex)))}var jp=/^:[\w-]+$/,Op=3,Ip=2,$p=1,zp=10,Mp=-2,hc=l=>l==="*";function Dp(l,u){let s=l.split("/"),m=s.length;return s.some(hc)&&(m+=Mp),u&&(m+=Ip),s.filter(d=>!hc(d)).reduce((d,g)=>d+(jp.test(g)?Op:g===""?$p:zp),m)}function Fp(l,u){return l.length===u.length&&l.slice(0,-1).every((m,d)=>m===u[d])?l[l.length-1]-u[u.length-1]:0}function Ap(l,u,s=!1){let{routesMeta:m}=l,d={},g="/",S=[];for(let E=0;E<m.length;++E){let k=m[E],x=E===m.length-1,j=g==="/"?u:u.slice(g.length)||"/",$=Xo({path:k.relativePath,caseSensitive:k.caseSensitive,end:x},j),N=k.route;if(!$&&x&&s&&!m[m.length-1].route.index&&($=Xo({path:k.relativePath,caseSensitive:k.caseSensitive,end:!1},j)),!$)return null;Object.assign(d,$.params),S.push({params:d,pathname:jt([g,$.pathname]),pathnameBase:qp(jt([g,$.pathnameBase])),route:N}),$.pathnameBase!=="/"&&(g=jt([g,$.pathnameBase]))}return S}function Xo(l,u){typeof l=="string"&&(l={path:l,caseSensitive:!1,end:!0});let[s,m]=Up(l.path,l.caseSensitive,l.end),d=u.match(s);if(!d)return null;let g=d[0],S=g.replace(/(.)\/+$/,"$1"),E=d.slice(1);return{params:m.reduce((x,{paramName:j,isOptional:$},N)=>{if(j==="*"){let O=E[N]||"";S=g.slice(0,g.length-O.length).replace(/(.)\/+$/,"$1")}const z=E[N];return $&&!z?x[j]=void 0:x[j]=(z||"").replace(/%2F/g,"/"),x},{}),pathname:g,pathnameBase:S,pattern:l}}function Up(l,u=!1,s=!0){St(l==="*"||!l.endsWith("*")||l.endsWith("/*"),`Route path "${l}" will be treated as if it were "${l.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${l.replace(/\*$/,"/*")}".`);let m=[],d="^"+l.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(S,E,k)=>(m.push({paramName:E,isOptional:k!=null}),k?"/?([^\\/]+)?":"/([^\\/]+)"));return l.endsWith("*")?(m.push({paramName:"*"}),d+=l==="*"||l==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):s?d+="\\/*$":l!==""&&l!=="/"&&(d+="(?:(?=\\/|$))"),[new RegExp(d,u?void 0:"i"),m]}function Bp(l){try{return l.split("/").map(u=>decodeURIComponent(u).replace(/\//g,"%2F")).join("/")}catch(u){return St(!1,`The URL path "${l}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${u}).`),l}}function Zt(l,u){if(u==="/")return l;if(!l.toLowerCase().startsWith(u.toLowerCase()))return null;let s=u.endsWith("/")?u.length-1:u.length,m=l.charAt(s);return m&&m!=="/"?null:l.slice(s)||"/"}function Vp(l,u="/"){let{pathname:s,search:m="",hash:d=""}=typeof l=="string"?Un(l):l;return{pathname:s?s.startsWith("/")?s:Hp(s,u):u,search:Qp(m),hash:Gp(d)}}function Hp(l,u){let s=u.replace(/\/+$/,"").split("/");return l.split("/").forEach(d=>{d===".."?s.length>1&&s.pop():d!=="."&&s.push(d)}),s.length>1?s.join("/"):"/"}function Yl(l,u,s,m){return`Cannot include a '${l}' character in a manually specified \`to.${u}\` field [${JSON.stringify(m)}].  Please separate it out to the \`to.${s}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function Wp(l){return l.filter((u,s)=>s===0||u.route.path&&u.route.path.length>0)}function xc(l){let u=Wp(l);return u.map((s,m)=>m===u.length-1?s.pathname:s.pathnameBase)}function Sc(l,u,s,m=!1){let d;typeof l=="string"?d=Un(l):(d={...l},ve(!d.pathname||!d.pathname.includes("?"),Yl("?","pathname","search",d)),ve(!d.pathname||!d.pathname.includes("#"),Yl("#","pathname","hash",d)),ve(!d.search||!d.search.includes("#"),Yl("#","search","hash",d)));let g=l===""||d.pathname==="",S=g?"/":d.pathname,E;if(S==null)E=s;else{let $=u.length-1;if(!m&&S.startsWith("..")){let N=S.split("/");for(;N[0]==="..";)N.shift(),$-=1;d.pathname=N.join("/")}E=$>=0?u[$]:"/"}let k=Vp(d,E),x=S&&S!=="/"&&S.endsWith("/"),j=(g||S===".")&&s.endsWith("/");return!k.pathname.endsWith("/")&&(x||j)&&(k.pathname+="/"),k}var jt=l=>l.join("/").replace(/\/\/+/g,"/"),qp=l=>l.replace(/\/+$/,"").replace(/^\/*/,"/"),Qp=l=>!l||l==="?"?"":l.startsWith("?")?l:"?"+l,Gp=l=>!l||l==="#"?"":l.startsWith("#")?l:"#"+l;function Kp(l){return l!=null&&typeof l.status=="number"&&typeof l.statusText=="string"&&typeof l.internal=="boolean"&&"data"in l}var Ec=["POST","PUT","PATCH","DELETE"];new Set(Ec);var Xp=["GET",...Ec];new Set(Xp);var Bn=R.createContext(null);Bn.displayName="DataRouter";var Yo=R.createContext(null);Yo.displayName="DataRouterState";var Cc=R.createContext({isTransitioning:!1});Cc.displayName="ViewTransition";var Yp=R.createContext(new Map);Yp.displayName="Fetchers";var Jp=R.createContext(null);Jp.displayName="Await";var Et=R.createContext(null);Et.displayName="Navigation";var jr=R.createContext(null);jr.displayName="Location";var Ot=R.createContext({outlet:null,matches:[],isDataRoute:!1});Ot.displayName="Route";var ra=R.createContext(null);ra.displayName="RouteError";function Zp(l,{relative:u}={}){ve(Or(),"useHref() may be used only in the context of a <Router> component.");let{basename:s,navigator:m}=R.useContext(Et),{hash:d,pathname:g,search:S}=Ir(l,{relative:u}),E=g;return s!=="/"&&(E=g==="/"?s:jt([s,g])),m.createHref({pathname:E,search:S,hash:d})}function Or(){return R.useContext(jr)!=null}function hn(){return ve(Or(),"useLocation() may be used only in the context of a <Router> component."),R.useContext(jr).location}var Rc="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function _c(l){R.useContext(Et).static||R.useLayoutEffect(l)}function em(){let{isDataRoute:l}=R.useContext(Ot);return l?pm():tm()}function tm(){ve(Or(),"useNavigate() may be used only in the context of a <Router> component.");let l=R.useContext(Bn),{basename:u,navigator:s}=R.useContext(Et),{matches:m}=R.useContext(Ot),{pathname:d}=hn(),g=JSON.stringify(xc(m)),S=R.useRef(!1);return _c(()=>{S.current=!0}),R.useCallback((k,x={})=>{if(St(S.current,Rc),!S.current)return;if(typeof k=="number"){s.go(k);return}let j=Sc(k,JSON.parse(g),d,x.relative==="path");l==null&&u!=="/"&&(j.pathname=j.pathname==="/"?u:jt([u,j.pathname])),(x.replace?s.replace:s.push)(j,x.state,x)},[u,s,g,d,l])}R.createContext(null);function Ir(l,{relative:u}={}){let{matches:s}=R.useContext(Ot),{pathname:m}=hn(),d=JSON.stringify(xc(s));return R.useMemo(()=>Sc(l,JSON.parse(d),m,u==="path"),[l,d,m,u])}function nm(l,u){return bc(l,u)}function bc(l,u,s,m){var K;ve(Or(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:d,static:g}=R.useContext(Et),{matches:S}=R.useContext(Ot),E=S[S.length-1],k=E?E.params:{},x=E?E.pathname:"/",j=E?E.pathnameBase:"/",$=E&&E.route;{let W=$&&$.path||"";Pc(x,!$||W.endsWith("*")||W.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${x}" (under <Route path="${W}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${W}"> to <Route path="${W==="/"?"*":`${W}/*`}">.`)}let N=hn(),z;if(u){let W=typeof u=="string"?Un(u):u;ve(j==="/"||((K=W.pathname)==null?void 0:K.startsWith(j)),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${j}" but pathname "${W.pathname}" was given in the \`location\` prop.`),z=W}else z=N;let O=z.pathname||"/",A=O;if(j!=="/"){let W=j.replace(/^\//,"").split("/");A="/"+O.replace(/^\//,"").split("/").slice(W.length).join("/")}let I=!g&&s&&s.matches&&s.matches.length>0?s.matches:vc(l,{pathname:A});St($||I!=null,`No routes matched location "${z.pathname}${z.search}${z.hash}" `),St(I==null||I[I.length-1].route.element!==void 0||I[I.length-1].route.Component!==void 0||I[I.length-1].route.lazy!==void 0,`Matched leaf route at location "${z.pathname}${z.search}${z.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let M=am(I&&I.map(W=>Object.assign({},W,{params:Object.assign({},k,W.params),pathname:jt([j,d.encodeLocation?d.encodeLocation(W.pathname).pathname:W.pathname]),pathnameBase:W.pathnameBase==="/"?j:jt([j,d.encodeLocation?d.encodeLocation(W.pathnameBase).pathname:W.pathnameBase])})),S,s,m);return u&&M?R.createElement(jr.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...z},navigationType:"POP"}},M):M}function rm(){let l=fm(),u=Kp(l)?`${l.status} ${l.statusText}`:l instanceof Error?l.message:JSON.stringify(l),s=l instanceof Error?l.stack:null,m="rgba(200,200,200, 0.5)",d={padding:"0.5rem",backgroundColor:m},g={padding:"2px 4px",backgroundColor:m},S=null;return console.error("Error handled by React Router default ErrorBoundary:",l),S=R.createElement(R.Fragment,null,R.createElement("p",null,"💿 Hey developer 👋"),R.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",R.createElement("code",{style:g},"ErrorBoundary")," or"," ",R.createElement("code",{style:g},"errorElement")," prop on your route.")),R.createElement(R.Fragment,null,R.createElement("h2",null,"Unexpected Application Error!"),R.createElement("h3",{style:{fontStyle:"italic"}},u),s?R.createElement("pre",{style:d},s):null,S)}var om=R.createElement(rm,null),im=class extends R.Component{constructor(l){super(l),this.state={location:l.location,revalidation:l.revalidation,error:l.error}}static getDerivedStateFromError(l){return{error:l}}static getDerivedStateFromProps(l,u){return u.location!==l.location||u.revalidation!=="idle"&&l.revalidation==="idle"?{error:l.error,location:l.location,revalidation:l.revalidation}:{error:l.error!==void 0?l.error:u.error,location:u.location,revalidation:l.revalidation||u.revalidation}}componentDidCatch(l,u){console.error("React Router caught the following error during render",l,u)}render(){return this.state.error!==void 0?R.createElement(Ot.Provider,{value:this.props.routeContext},R.createElement(ra.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function lm({routeContext:l,match:u,children:s}){let m=R.useContext(Bn);return m&&m.static&&m.staticContext&&(u.route.errorElement||u.route.ErrorBoundary)&&(m.staticContext._deepestRenderedBoundaryId=u.route.id),R.createElement(Ot.Provider,{value:l},s)}function am(l,u=[],s=null,m=null){if(l==null){if(!s)return null;if(s.errors)l=s.matches;else if(u.length===0&&!s.initialized&&s.matches.length>0)l=s.matches;else return null}let d=l,g=s==null?void 0:s.errors;if(g!=null){let k=d.findIndex(x=>x.route.id&&(g==null?void 0:g[x.route.id])!==void 0);ve(k>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(g).join(",")}`),d=d.slice(0,Math.min(d.length,k+1))}let S=!1,E=-1;if(s)for(let k=0;k<d.length;k++){let x=d[k];if((x.route.HydrateFallback||x.route.hydrateFallbackElement)&&(E=k),x.route.id){let{loaderData:j,errors:$}=s,N=x.route.loader&&!j.hasOwnProperty(x.route.id)&&(!$||$[x.route.id]===void 0);if(x.route.lazy||N){S=!0,E>=0?d=d.slice(0,E+1):d=[d[0]];break}}}return d.reduceRight((k,x,j)=>{let $,N=!1,z=null,O=null;s&&($=g&&x.route.id?g[x.route.id]:void 0,z=x.route.errorElement||om,S&&(E<0&&j===0?(Pc("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),N=!0,O=null):E===j&&(N=!0,O=x.route.hydrateFallbackElement||null)));let A=u.concat(d.slice(0,j+1)),I=()=>{let M;return $?M=z:N?M=O:x.route.Component?M=R.createElement(x.route.Component,null):x.route.element?M=x.route.element:M=k,R.createElement(lm,{match:x,routeContext:{outlet:k,matches:A,isDataRoute:s!=null},children:M})};return s&&(x.route.ErrorBoundary||x.route.errorElement||j===0)?R.createElement(im,{location:s.location,revalidation:s.revalidation,component:z,error:$,children:I(),routeContext:{outlet:null,matches:A,isDataRoute:!0}}):I()},null)}function oa(l){return`${l} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function sm(l){let u=R.useContext(Bn);return ve(u,oa(l)),u}function um(l){let u=R.useContext(Yo);return ve(u,oa(l)),u}function cm(l){let u=R.useContext(Ot);return ve(u,oa(l)),u}function ia(l){let u=cm(l),s=u.matches[u.matches.length-1];return ve(s.route.id,`${l} can only be used on routes that contain a unique "id"`),s.route.id}function dm(){return ia("useRouteId")}function fm(){var m;let l=R.useContext(ra),u=um("useRouteError"),s=ia("useRouteError");return l!==void 0?l:(m=u.errors)==null?void 0:m[s]}function pm(){let{router:l}=sm("useNavigate"),u=ia("useNavigate"),s=R.useRef(!1);return _c(()=>{s.current=!0}),R.useCallback(async(d,g={})=>{St(s.current,Rc),s.current&&(typeof d=="number"?l.navigate(d):await l.navigate(d,{fromRouteId:u,...g}))},[l,u])}var gc={};function Pc(l,u,s){!u&&!gc[l]&&(gc[l]=!0,St(!1,s))}R.memo(mm);function mm({routes:l,future:u,state:s}){return bc(l,void 0,s,u)}function ea(l){ve(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function hm({basename:l="/",children:u=null,location:s,navigationType:m="POP",navigator:d,static:g=!1}){ve(!Or(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let S=l.replace(/^\/*/,"/"),E=R.useMemo(()=>({basename:S,navigator:d,static:g,future:{}}),[S,d,g]);typeof s=="string"&&(s=Un(s));let{pathname:k="/",search:x="",hash:j="",state:$=null,key:N="default"}=s,z=R.useMemo(()=>{let O=Zt(k,S);return O==null?null:{location:{pathname:O,search:x,hash:j,state:$,key:N},navigationType:m}},[S,k,x,j,$,N,m]);return St(z!=null,`<Router basename="${S}"> is not able to match the URL "${k}${x}${j}" because it does not start with the basename, so the <Router> won't render anything.`),z==null?null:R.createElement(Et.Provider,{value:E},R.createElement(jr.Provider,{children:u,value:z}))}function gm({children:l,location:u}){return nm(ta(l),u)}function ta(l,u=[]){let s=[];return R.Children.forEach(l,(m,d)=>{if(!R.isValidElement(m))return;let g=[...u,d];if(m.type===R.Fragment){s.push.apply(s,ta(m.props.children,g));return}ve(m.type===ea,`[${typeof m.type=="string"?m.type:m.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),ve(!m.props.index||!m.props.children,"An index route cannot have child routes.");let S={id:m.props.id||g.join("-"),caseSensitive:m.props.caseSensitive,element:m.props.element,Component:m.props.Component,index:m.props.index,path:m.props.path,loader:m.props.loader,action:m.props.action,hydrateFallbackElement:m.props.hydrateFallbackElement,HydrateFallback:m.props.HydrateFallback,errorElement:m.props.errorElement,ErrorBoundary:m.props.ErrorBoundary,hasErrorBoundary:m.props.hasErrorBoundary===!0||m.props.ErrorBoundary!=null||m.props.errorElement!=null,shouldRevalidate:m.props.shouldRevalidate,handle:m.props.handle,lazy:m.props.lazy};m.props.children&&(S.children=ta(m.props.children,g)),s.push(S)}),s}var Go="get",Ko="application/x-www-form-urlencoded";function Jo(l){return l!=null&&typeof l.tagName=="string"}function ym(l){return Jo(l)&&l.tagName.toLowerCase()==="button"}function vm(l){return Jo(l)&&l.tagName.toLowerCase()==="form"}function wm(l){return Jo(l)&&l.tagName.toLowerCase()==="input"}function km(l){return!!(l.metaKey||l.altKey||l.ctrlKey||l.shiftKey)}function xm(l,u){return l.button===0&&(!u||u==="_self")&&!km(l)}var Qo=null;function Sm(){if(Qo===null)try{new FormData(document.createElement("form"),0),Qo=!1}catch{Qo=!0}return Qo}var Em=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function Jl(l){return l!=null&&!Em.has(l)?(St(!1,`"${l}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Ko}"`),null):l}function Cm(l,u){let s,m,d,g,S;if(vm(l)){let E=l.getAttribute("action");m=E?Zt(E,u):null,s=l.getAttribute("method")||Go,d=Jl(l.getAttribute("enctype"))||Ko,g=new FormData(l)}else if(ym(l)||wm(l)&&(l.type==="submit"||l.type==="image")){let E=l.form;if(E==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let k=l.getAttribute("formaction")||E.getAttribute("action");if(m=k?Zt(k,u):null,s=l.getAttribute("formmethod")||E.getAttribute("method")||Go,d=Jl(l.getAttribute("formenctype"))||Jl(E.getAttribute("enctype"))||Ko,g=new FormData(E,l),!Sm()){let{name:x,type:j,value:$}=l;if(j==="image"){let N=x?`${x}.`:"";g.append(`${N}x`,"0"),g.append(`${N}y`,"0")}else x&&g.append(x,$)}}else{if(Jo(l))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');s=Go,m=null,d=Ko,S=l}return g&&d==="text/plain"&&(S=g,g=void 0),{action:m,method:s.toLowerCase(),encType:d,formData:g,body:S}}function la(l,u){if(l===!1||l===null||typeof l>"u")throw new Error(u)}async function Rm(l,u){if(l.id in u)return u[l.id];try{let s=await import(l.module);return u[l.id]=s,s}catch(s){return console.error(`Error loading route module \`${l.module}\`, reloading page...`),console.error(s),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function _m(l){return l==null?!1:l.href==null?l.rel==="preload"&&typeof l.imageSrcSet=="string"&&typeof l.imageSizes=="string":typeof l.rel=="string"&&typeof l.href=="string"}async function bm(l,u,s){let m=await Promise.all(l.map(async d=>{let g=u.routes[d.route.id];if(g){let S=await Rm(g,s);return S.links?S.links():[]}return[]}));return Tm(m.flat(1).filter(_m).filter(d=>d.rel==="stylesheet"||d.rel==="preload").map(d=>d.rel==="stylesheet"?{...d,rel:"prefetch",as:"style"}:{...d,rel:"prefetch"}))}function yc(l,u,s,m,d,g){let S=(k,x)=>s[x]?k.route.id!==s[x].route.id:!0,E=(k,x)=>{var j;return s[x].pathname!==k.pathname||((j=s[x].route.path)==null?void 0:j.endsWith("*"))&&s[x].params["*"]!==k.params["*"]};return g==="assets"?u.filter((k,x)=>S(k,x)||E(k,x)):g==="data"?u.filter((k,x)=>{var $;let j=m.routes[k.route.id];if(!j||!j.hasLoader)return!1;if(S(k,x)||E(k,x))return!0;if(k.route.shouldRevalidate){let N=k.route.shouldRevalidate({currentUrl:new URL(d.pathname+d.search+d.hash,window.origin),currentParams:(($=s[0])==null?void 0:$.params)||{},nextUrl:new URL(l,window.origin),nextParams:k.params,defaultShouldRevalidate:!0});if(typeof N=="boolean")return N}return!0}):[]}function Pm(l,u){return Nm(l.map(s=>{let m=u.routes[s.route.id];if(!m)return[];let d=[m.module];return m.imports&&(d=d.concat(m.imports)),d}).flat(1))}function Nm(l){return[...new Set(l)]}function Lm(l){let u={},s=Object.keys(l).sort();for(let m of s)u[m]=l[m];return u}function Tm(l,u){let s=new Set;return new Set(u),l.reduce((m,d)=>{let g=JSON.stringify(Lm(d));return s.has(g)||(s.add(g),m.push({key:g,link:d})),m},[])}function jm(l){let u=typeof l=="string"?new URL(l,typeof window>"u"?"server://singlefetch/":window.location.origin):l;return u.pathname==="/"?u.pathname="_root.data":u.pathname=`${u.pathname.replace(/\/$/,"")}.data`,u}function Om(){let l=R.useContext(Bn);return la(l,"You must render this element inside a <DataRouterContext.Provider> element"),l}function Im(){let l=R.useContext(Yo);return la(l,"You must render this element inside a <DataRouterStateContext.Provider> element"),l}var aa=R.createContext(void 0);aa.displayName="FrameworkContext";function Nc(){let l=R.useContext(aa);return la(l,"You must render this element inside a <HydratedRouter> element"),l}function $m(l,u){let s=R.useContext(aa),[m,d]=R.useState(!1),[g,S]=R.useState(!1),{onFocus:E,onBlur:k,onMouseEnter:x,onMouseLeave:j,onTouchStart:$}=u,N=R.useRef(null);R.useEffect(()=>{if(l==="render"&&S(!0),l==="viewport"){let A=M=>{M.forEach(K=>{S(K.isIntersecting)})},I=new IntersectionObserver(A,{threshold:.5});return N.current&&I.observe(N.current),()=>{I.disconnect()}}},[l]),R.useEffect(()=>{if(m){let A=setTimeout(()=>{S(!0)},100);return()=>{clearTimeout(A)}}},[m]);let z=()=>{d(!0)},O=()=>{d(!1),S(!1)};return s?l!=="intent"?[g,N,{}]:[g,N,{onFocus:Lr(E,z),onBlur:Lr(k,O),onMouseEnter:Lr(x,z),onMouseLeave:Lr(j,O),onTouchStart:Lr($,z)}]:[!1,N,{}]}function Lr(l,u){return s=>{l&&l(s),s.defaultPrevented||u(s)}}function zm({page:l,...u}){let{router:s}=Om(),m=R.useMemo(()=>vc(s.routes,l,s.basename),[s.routes,l,s.basename]);return m?R.createElement(Dm,{page:l,matches:m,...u}):null}function Mm(l){let{manifest:u,routeModules:s}=Nc(),[m,d]=R.useState([]);return R.useEffect(()=>{let g=!1;return bm(l,u,s).then(S=>{g||d(S)}),()=>{g=!0}},[l,u,s]),m}function Dm({page:l,matches:u,...s}){let m=hn(),{manifest:d,routeModules:g}=Nc(),{loaderData:S,matches:E}=Im(),k=R.useMemo(()=>yc(l,u,E,d,m,"data"),[l,u,E,d,m]),x=R.useMemo(()=>yc(l,u,E,d,m,"assets"),[l,u,E,d,m]),j=R.useMemo(()=>{if(l===m.pathname+m.search+m.hash)return[];let z=new Set,O=!1;if(u.forEach(I=>{var K;let M=d.routes[I.route.id];!M||!M.hasLoader||(!k.some(W=>W.route.id===I.route.id)&&I.route.id in S&&((K=g[I.route.id])!=null&&K.shouldRevalidate)||M.hasClientLoader?O=!0:z.add(I.route.id))}),z.size===0)return[];let A=jm(l);return O&&z.size>0&&A.searchParams.set("_routes",u.filter(I=>z.has(I.route.id)).map(I=>I.route.id).join(",")),[A.pathname+A.search]},[S,m,d,k,u,l,g]),$=R.useMemo(()=>Pm(x,d),[x,d]),N=Mm(x);return R.createElement(R.Fragment,null,j.map(z=>R.createElement("link",{key:z,rel:"prefetch",as:"fetch",href:z,...s})),$.map(z=>R.createElement("link",{key:z,rel:"modulepreload",href:z,...s})),N.map(({key:z,link:O})=>R.createElement("link",{key:z,...O})))}function Fm(...l){return u=>{l.forEach(s=>{typeof s=="function"?s(u):s!=null&&(s.current=u)})}}var Lc=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{Lc&&(window.__reactRouterVersion="7.1.5")}catch{}function Am({basename:l,children:u,window:s}){let m=R.useRef();m.current==null&&(m.current=bp({window:s,v5Compat:!0}));let d=m.current,[g,S]=R.useState({action:d.action,location:d.location}),E=R.useCallback(k=>{R.startTransition(()=>S(k))},[S]);return R.useLayoutEffect(()=>d.listen(E),[d,E]),R.createElement(hm,{basename:l,children:u,location:g.location,navigationType:g.action,navigator:d})}var Tc=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,sa=R.forwardRef(function({onClick:u,discover:s="render",prefetch:m="none",relative:d,reloadDocument:g,replace:S,state:E,target:k,to:x,preventScrollReset:j,viewTransition:$,...N},z){let{basename:O}=R.useContext(Et),A=typeof x=="string"&&Tc.test(x),I,M=!1;if(typeof x=="string"&&A&&(I=x,Lc))try{let ke=new URL(window.location.href),Ne=x.startsWith("//")?new URL(ke.protocol+x):new URL(x),mt=Zt(Ne.pathname,O);Ne.origin===ke.origin&&mt!=null?x=mt+Ne.search+Ne.hash:M=!0}catch{St(!1,`<Link to="${x}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let K=Zp(x,{relative:d}),[W,te,se]=$m(m,N),we=Hm(x,{replace:S,state:E,target:k,preventScrollReset:j,relative:d,viewTransition:$});function he(ke){u&&u(ke),ke.defaultPrevented||we(ke)}let Re=R.createElement("a",{...N,...se,href:I||K,onClick:M||g?u:he,ref:Fm(z,te),target:k,"data-discover":!A&&s==="render"?"true":void 0});return W&&!A?R.createElement(R.Fragment,null,Re,R.createElement(zm,{page:K})):Re});sa.displayName="Link";var Um=R.forwardRef(function({"aria-current":u="page",caseSensitive:s=!1,className:m="",end:d=!1,style:g,to:S,viewTransition:E,children:k,...x},j){let $=Ir(S,{relative:x.relative}),N=hn(),z=R.useContext(Yo),{navigator:O,basename:A}=R.useContext(Et),I=z!=null&&Km($)&&E===!0,M=O.encodeLocation?O.encodeLocation($).pathname:$.pathname,K=N.pathname,W=z&&z.navigation&&z.navigation.location?z.navigation.location.pathname:null;s||(K=K.toLowerCase(),W=W?W.toLowerCase():null,M=M.toLowerCase()),W&&A&&(W=Zt(W,A)||W);const te=M!=="/"&&M.endsWith("/")?M.length-1:M.length;let se=K===M||!d&&K.startsWith(M)&&K.charAt(te)==="/",we=W!=null&&(W===M||!d&&W.startsWith(M)&&W.charAt(M.length)==="/"),he={isActive:se,isPending:we,isTransitioning:I},Re=se?u:void 0,ke;typeof m=="function"?ke=m(he):ke=[m,se?"active":null,we?"pending":null,I?"transitioning":null].filter(Boolean).join(" ");let Ne=typeof g=="function"?g(he):g;return R.createElement(sa,{...x,"aria-current":Re,className:ke,ref:j,style:Ne,to:S,viewTransition:E},typeof k=="function"?k(he):k)});Um.displayName="NavLink";var Bm=R.forwardRef(({discover:l="render",fetcherKey:u,navigate:s,reloadDocument:m,replace:d,state:g,method:S=Go,action:E,onSubmit:k,relative:x,preventScrollReset:j,viewTransition:$,...N},z)=>{let O=Qm(),A=Gm(E,{relative:x}),I=S.toLowerCase()==="get"?"get":"post",M=typeof E=="string"&&Tc.test(E),K=W=>{if(k&&k(W),W.defaultPrevented)return;W.preventDefault();let te=W.nativeEvent.submitter,se=(te==null?void 0:te.getAttribute("formmethod"))||S;O(te||W.currentTarget,{fetcherKey:u,method:se,navigate:s,replace:d,state:g,relative:x,preventScrollReset:j,viewTransition:$})};return R.createElement("form",{ref:z,method:I,action:A,onSubmit:m?k:K,...N,"data-discover":!M&&l==="render"?"true":void 0})});Bm.displayName="Form";function Vm(l){return`${l} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function jc(l){let u=R.useContext(Bn);return ve(u,Vm(l)),u}function Hm(l,{target:u,replace:s,state:m,preventScrollReset:d,relative:g,viewTransition:S}={}){let E=em(),k=hn(),x=Ir(l,{relative:g});return R.useCallback(j=>{if(xm(j,u)){j.preventDefault();let $=s!==void 0?s:Tr(k)===Tr(x);E(l,{replace:$,state:m,preventScrollReset:d,relative:g,viewTransition:S})}},[k,E,x,s,m,u,l,d,g,S])}var Wm=0,qm=()=>`__${String(++Wm)}__`;function Qm(){let{router:l}=jc("useSubmit"),{basename:u}=R.useContext(Et),s=dm();return R.useCallback(async(m,d={})=>{let{action:g,method:S,encType:E,formData:k,body:x}=Cm(m,u);if(d.navigate===!1){let j=d.fetcherKey||qm();await l.fetch(j,s,d.action||g,{preventScrollReset:d.preventScrollReset,formData:k,body:x,formMethod:d.method||S,formEncType:d.encType||E,flushSync:d.flushSync})}else await l.navigate(d.action||g,{preventScrollReset:d.preventScrollReset,formData:k,body:x,formMethod:d.method||S,formEncType:d.encType||E,replace:d.replace,state:d.state,fromRouteId:s,flushSync:d.flushSync,viewTransition:d.viewTransition})},[l,u,s])}function Gm(l,{relative:u}={}){let{basename:s}=R.useContext(Et),m=R.useContext(Ot);ve(m,"useFormAction must be used inside a RouteContext");let[d]=m.matches.slice(-1),g={...Ir(l||".",{relative:u})},S=hn();if(l==null){g.search=S.search;let E=new URLSearchParams(g.search),k=E.getAll("index");if(k.some(j=>j==="")){E.delete("index"),k.filter($=>$).forEach($=>E.append("index",$));let j=E.toString();g.search=j?`?${j}`:""}}return(!l||l===".")&&d.route.index&&(g.search=g.search?g.search.replace(/^\?/,"?index&"):"?index"),s!=="/"&&(g.pathname=g.pathname==="/"?s:jt([s,g.pathname])),Tr(g)}function Km(l,u={}){let s=R.useContext(Cc);ve(s!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:m}=jc("useViewTransitionState"),d=Ir(l,{relative:u.relative});if(!s.isTransitioning)return!1;let g=Zt(s.currentLocation.pathname,m)||s.currentLocation.pathname,S=Zt(s.nextLocation.pathname,m)||s.nextLocation.pathname;return Xo(d.pathname,S)!=null||Xo(d.pathname,g)!=null}new TextEncoder;function Xm(){return C.jsxs("div",{className:"flex min-h-screen flex-col items-center justify-center bg-gray-100 p-6 text-center",children:[C.jsx("h1",{className:"text-6xl font-bold text-gray-800",children:"404"}),C.jsx("p",{className:"mt-2 text-lg text-gray-600",children:"Page Not Found"}),C.jsx(sa,{to:"/",className:"mt-4 text-blue-500 hover:underline",children:"Go Back Home"})]})}function Ym(){return C.jsx(C.Fragment,{children:C.jsx(Am,{children:C.jsxs(gm,{children:[C.jsx(ea,{path:"/",element:C.jsx(Rp,{})}),C.jsx(ea,{path:"*",element:C.jsx(Xm,{})})]})})})}Df.createRoot(document.getElementById("root")).render(C.jsx(R.StrictMode,{children:C.jsx(Ym,{})}));
